...
<style>
	...
	<div class="mui-navbar-inner mui-bar mui-bar-nav mui-hbar">
		...
		<h1 class="mui-center mui-title" style="color:white;">确认收货</h1>
	</div>
	<!--页面标题栏结束-->
	<!--页面主内容区开始-->
			...
			<div class="mui-scroll">
				<ul class="mui-table-view mui-table-view-radio">
					<li>
						<div class="mui-row" style="height: 30px;background-color: #00CED1; color:white;">
					    	<span class="a-store">订单号 : <?php echo $account_no; ?></span>
				    	</div>
					</li>
					<li class="mui-table-view-cell mui-cc mui-selected">
						<a class="mui-navigate-right">
							无运输损耗
						</a>
					</li>
					<li class="mui-table-view-cell mui-aa">
						<a class="mui-navigate-right">
							有运输损耗
						</a>
					</li>
						...
						<li class=" big-li">
					        ...
					        <?php foreach ($materials_get as $key1 => $material_s): ?>
								<li class="mui-table-view-cell mui-collapse mui-active" style="background-color: white;">
									<a class="mui-navigate-right" href="#" style="height: 40px;padding-top:5px;background-color: #F5F5F5; color:#6600CC;"><span><?php echo '配送单号 : '.$key1; ?></span></a>
				...
				<ul class="mui-table-view" >
					<li class="mui-table-view-cell" style="background-color: #FFFFF0;height:80px;">
						<button type="button" class="mui-btn mui-btn-danger mui-btn-outlined " style="border-radius: 10px;margin:20px auto;z-index:1;" account_no="<?php echo $account_no; ?>">确认收货</button>
					</li>
				</ul>
			</div>
		</div>
