...
<div class="mui-content " style="margin-bottom: 50px;">
	...
	<div style="padding: 10px 10px;">
		<div id="segmentedControl" class="mui-segmented-control">
			...
			<a class="mui-control-item  mui-active" href="<?php echo $this->createUrl('myinfo/goodsOrderNoget',array('companyId'=>$this->companyId));?>">待收货<?php  if ($noget_no) {echo '('.$noget_no.')';} ?></a>
		...
		<div  id="content">
			...
			<div class="mui-card">
				...
				<div class="mui-card-footer">
					...
					<a class="mui-card-link" href="<?php echo $this->createUrl('myinfo/orderDetail',array('companyId'=>$this->companyId,'account_no'=>$goods_order['account_no'],'type'=>3));?>">查看详情</a>
				</div>
			</div>
			<?php endforeach;?>
		</div>
		...
		btn.addEventListener('tap', function() {
			...
			if(_self.picker) {
				...
				_self.picker.show(function(rs) {
					...
					// result.value = rs.text;
					location.href='<?php echo $this->createUrl('myinfo/goodsOrderNoget',array('companyId'=>$this->companyId)); ?>/date/'+rs.text;
					/* 
					 * 返回 false 可以阻止选择框的关闭
					 * return false;
					 */
