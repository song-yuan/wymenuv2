...
<div class="dp">
	<div style="margin-top: 10px;border-bottom: 1px solid #efeff4;">
		<ul class="ul">
			...
			<li class="li-4">说明</li>
			<li class="li-4">操作</li>
			<li class="li-4"><a href="<?php echo $this->createUrl('appReport/createCsfl',array('companyId'=>$this->companyId));?>">添加</a></li>
	...
	<div class="dp1">
		<ul class="ul">
			...
			<li class="li-4"><?php echo $model['classification_name'];?></li>
			<li class="li-4"><?php echo $model['remark'];?></li>
			<li class="li-4"><a href="<?php echo $this->createUrl('appReport/createCsfl',array('companyId'=>$this->companyId,'id'=>$model['lid']));?>">编辑</a>&nbsp;&nbsp;<a class="delete" onclick="deleteItem('<?php echo $model['lid'];?>')">删除</a></li>
			<?php endforeach;?>
		</ul>
	</div>
</div>
...
function deleteItem(id){
	...
	mui.confirm('是否删除该厂商分类', '提示', btnArray, function(e) {
		if (e.index == 0) {
			location.href = "<?php echo $this->createUrl('appReport/deleteCsfl',array('companyId'=>$this->companyId));?>/id/"+id;
		}
	});
}
</script>