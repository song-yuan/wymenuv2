...
<div class="dp">
	<div style="margin-top: 10px;">
		<ul class="ul">
			<li class="li-4">操作员</li>
			<li class="li-4">盘损日期</li>
			<li class="li-4">盘损原因</li>
			<li class="li-4">盘损详情</li>
	...
	<?php foreach($models as $model):?>
		<ul class="ul">
			<li class="li-4"><?php echo $model->opretion_id;?></li>
			<li class="li-4"><?php echo date('Y-m-d',strtotime($model->create_at));?></li>
			<li class="li-4"><?php 
				foreach ($retreats as $re){
					if($model->reason_id==$re['lid']){
						echo $re['name'];
					}
				}
			?></li>
			<a href="<?php echo $this->createUrl('appReport/psdetail',array('companyId'=>$this->companyId,'id'=>$model->lid));?>"><li class="li-4">盘损详情</li></a>
			<div style="clear: both;"></div>
		</ul>
		<?php endforeach;?>
	</div>
