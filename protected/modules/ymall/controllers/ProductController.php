...
class ProductController extends BaseYmallController
{
	...
	public function actionIndex()
	{
		$db = Yii::app()->db;
		//实时库存
		$sqls = 'select DISTINCT(`t`.material_name),stock.stock,safe.safe_stock,safe.max_stock,unit.unit_name,mc.category_name,t.category_id FROM `nb_product_material` `t`
