...
class MfrInformationController extends BackendController
{
	...
	public function actionCreate(){
		...
		$categories = $categories = ManufacturerInformation::model()->findAll('delete_flag=0 and dpid=:companyId' , array(':companyId' => $this->companyId)) ;
	...
	public function actionUpdate(){
		...
		$model = ManufacturerInformation::model()->find('lid=:materialId and dpid=:dpid' , array(':materialId' => $id,':dpid'=>  $this->companyId));
		$model->dpid = $this->companyId;
