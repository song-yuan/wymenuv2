	...
	public function actionDetailindex(){
		...
		if($typeId=='product')
		{
			...
			if(!empty($categoryId)){
				...
				$sql = 'select k.* from(select t1.product_name,t1.main_picture,t.* from nb_buysent_promotion_detail t left join nb_product t1 on(t.product_id = t1.lid and t.dpid = t1.dpid and t1.delete_flag =0) where t.buysent_pro_id = '.$promotionID.' and t.delete_flag = 0 and t.dpid = '.$this->companyId.' and t.is_set = 0 and t1.category_id = '.$categoryId.') k';
				//var_dump($sql);exit;
