...
class RefundOrderDetailController extends BackendController
{
	...
	public function actionCreate(){
		...
		$categories = $categories = RefundOrderDetail::model()->findAll('dpid=:companyId' , array(':companyId' => $this->companyId)) ;
	...
	public function actionUpdate(){
		...
		$model = RefundOrderDetail::model()->find('lid=:materialId and dpid=:dpid' , array(':materialId' => $id,':dpid'=>  $this->companyId));
		$model->dpid = $this->companyId;
