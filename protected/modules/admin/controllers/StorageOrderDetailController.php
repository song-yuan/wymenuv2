...
class StorageOrderDetailController extends BackendController
{
	...
	public function actionCreate(){
		...
		$categories = $categories = StorageOrderDetail::model()->findAll('dpid=:companyId' , array(':companyId' => $this->companyId)) ;
	...
	public function actionUpdate(){
		...
		$model = StorageOrderDetail::model()->find('lid=:materialId and dpid=:dpid' , array(':materialId' => $id,':dpid'=>  $this->companyId));
		$model->dpid = $this->companyId;
