...
class WechatMemberController extends BackendController {
    ...
    public function actionSearchDetail(){
		...
		$sql = 'select lid,dpid,create_at,account_no,reality_total,should_total from nb_order where lid in(select lid from nb_order where create_at > "'.$createAt.'" and user_id='.$brandUser['lid'].' and account_no > 0) and order_type in(1,2,3,5,6) and order_status in(3,4,8) order by lid desc';
