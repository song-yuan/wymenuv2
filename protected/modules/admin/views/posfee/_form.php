<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php if($this->comptype=='0'):?>
	  <div class="form-group">
			...
			<div class="col-md-4">
				<?php echo $form->textField($model, 'years',array('class' => 'form-control','placeholder'=>$model->getAttributeLabel('years')));?>
		...
		<div style="color: red;">&nbsp;提示：请慎重填写，加盟商会按照设置的金额进行续费延期。</div>
	<?php endif;?>
<?php $this->endWidget(); ?>
