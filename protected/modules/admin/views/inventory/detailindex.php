<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','盘损详情'),'subhead'=>yii::t('app','品项盘损列表'),'breadcrumbs'=>array(array('word'=>yii::t('app','品项盘损'),'url'=>''))));?>
	...
	$(document).ready(function(){
		...
		$('#status-0').click(function(){
			...
			if(confirm('确认盘损')){
				$.ajax({
					url:'<?php echo $this->createUrl('inventory/storageVerify',array('companyId'=>$this->companyId));?>',
					data:{type:1,pid:pid},
					success:function(msg){
						//alert(msg);
						if(msg=='true'){
