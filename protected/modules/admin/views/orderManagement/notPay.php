	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>'订单管理','subhead'=>'订单列表','breadcrumbs'=>array(array('word'=>'今日订单','url'=>''))));?>
				...
				<div class="portlet-body" id="table-manage">
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<?php foreach ($models as $model):?>
								...
								<td><?php if($model['is_temp']=='1') echo '临时坐'.$model['site_id']%1000; else echo $this->getSiteName();?></td>
								<td><?php echo $model['number'];?></td>
								<td><?php switch($model['order_status']) {case 1: echo '未下单'; break; case 2: echo '下单未支付' ; break; case 3: echo '已支付'; break; case 4: echo '已结单'; break; case 5: echo '被并台'; break; case 6: echo '被换台'; break; case 7: echo '被撤台'; break; case 8: echo '日结'; break;default :echo '';}?></td>
