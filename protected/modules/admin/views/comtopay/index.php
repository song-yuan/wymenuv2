...
<div class="page-content">
	...
	<div class="row">
            <?php $form=$this->beginWidget('CActiveForm', array(
				'id' => 'company-form',
				'action' => $this->createUrl('comtopay/delete', array('companyId' => $this->companyId)),
...
<script>
	...
	$('#serch').on('click',function(){
		...
		//alert(111);
         location.href="<?php echo $this->createUrl('comtopay/index' , array('companyId'=>$this->companyId));?>/content/"+content;
	});
	...
	$('.setAppid').on('click',function(){
		...
		$('#appid_store').on('click',function(){
			...
			var url = "<?php echo $this->createUrl('comtopay/store');?>/companyId/"+dpid+"/appid/"+appid+"/code/"+code+"/paytype/"+paytype+"/paychannel/"+paychannel;
	        $.ajax({
	            url:url,
	            type:'GET',
	            //data:orderid,//CF
