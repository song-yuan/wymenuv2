...
<div class="page-content">
    ...
    <!-- BEGIN PAGE HEADER-->
    <?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('breadcrumbs'=>array(array('word'=>yii::t('app','微信赠券'),'url'=>$this->createUrl('wechatMarket/list' , array('companyId'=>$this->companyId,'type'=>0,))),array('word'=>yii::t('app','给沉寂会员赠券'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('wechatMarket/list' , array('companyId' => $this->companyId,'type'=>0)))));?>
            <!-- END PAGE HEADER-->
            <!-- BEGIN PAGE CONTENT-->
    <div class="row">
    <?php $form=$this->beginWidget('CActiveForm', array(
		...
		<div class="tab-content">
                        ...
                        <div class="portlet box purple">
                            <div class="portlet-title">
                                <div class="caption">
                                    ...
                                    <?php echo yii::t('app','给沉寂会员赠券(*为必填项)');?>
                                </div>
                                <div class="actions">
                                    <?php if($model):?>
				...
				<?php if($model && $model->is_available=='0'):?>
                            ...
                            <?php else:?>
                            <span style=" font-size: 22px;color: red;">请先 '开启' 给沉寂会员赠券活动，再进行操作！</span>
                            <?php endif;?>
    ...
    $(document).ready(function(){
        ...
        $('.staclose').on('click' , function(){
                ...
                if($(this).hasClass('close1')){
                    location.href="<?php echo $this->createUrl('sentSleepMember/index' , array('companyId'=>$this->companyId));?>/is_new/3";
                     }else if($(this).hasClass('start1')){
                        location.href="<?php echo $this->createUrl('sentSleepMember/index' , array('companyId'=>$this->companyId));?>/is_new/1";
                     }else if($(this).hasClass('start2')){
                        location.href="<?php echo $this->createUrl('sentSleepMember/index' , array('companyId'=>$this->companyId));?>/is_new/2";
                     }
