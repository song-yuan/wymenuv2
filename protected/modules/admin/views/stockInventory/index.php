<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','进销存管理'),'subhead'=>yii::t('app','盘存单列表'),'breadcrumbs'=>array(array('word'=>yii::t('app','库存管理'),'url'=>$this->createUrl('bom/bom' , array('companyId'=>$this->companyId,'type'=>2,))),array('word'=>yii::t('app','盘存单'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('bom/bom' , array('companyId' => $this->companyId,'type' => '2',)))));?>
	...
	<div class="find">
		<form action="" method="post">
			...
			<input type="text" name="storage" class="form-control" placeholder="盘存单号" value="<?php echo isset($storage) && $storage ?$storage:'';?>" />
	...
	<div class="col-md-12">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-globe"></i><?php echo yii::t('app','盘存单列表');?></div>
					<div class="actions">
						<a href="<?php echo $this->createUrl('stockInventory/create' , array('companyId' => $this->companyId));?>" class="btn blue"><i class="fa fa-pencil"></i> <?php echo yii::t('app','添加');?></a>
						<div class="btn-group">
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						<thead>
							<tr>
								...
								<th><?php echo yii::t('app','盘存单号');?></th>
								<th><?php echo yii::t('app','盘存日期');?></th>
						...
						<?php foreach ($models as $model):?>
							<tr class="odd gradeX">
								...
								<td><?php echo $model->stock_inven_accountno;?></td>
								<td><?php echo $model->create_at;?></td>
								<td><?php echo $model->remark;?></td>
								<td><span style="color: red;"><?php if($model->status==1){ echo '已经盘存';}else{ echo '正在编辑';};?></span></td>
								<td class="center">
									<a href="<?php echo $this->createUrl('stockInventory/detailindex',array('lid' => $model->lid , 'companyId' => $model->dpid,'status' => $model->status,));?>"><?php echo yii::t('app','盘存单详情');?></a>
								</td>
								<td class="center">
								<?php if($model->status == 0 ):?>
									<a href="<?php echo $this->createUrl('stockInventory/update',array('lid' => $model->lid , 'companyId' => $model->dpid));?>"><?php echo yii::t('app','编辑');?></a>
								<?php endif;?>
								</td>
							</tr>
						<?php endforeach;?>
