        ...
        <div class="portlet box blue">
            ...
            <div class="portlet-body form">
                <div class="pbom">
                    ...
                    <div class="material"> 
                        <div class="materialhead">商品列表</div>
                        <div class="materialbody"> 
                                ...
                                <div id="<?php echo $material['lid'];?>" catid="<?php echo $material['category_id'];?>" class="bodymaterial">
                                        ...
                                        <div class="div2">
                                                 <input id="check<?php echo $material['lid'];?>" type="checkbox" stockname="<?php echo Common::getStockName($material['stock_unit_id']);?>" matename="<?php echo $material['goods_name'];?>" class="check" value="<?php echo $material['lid'];?>"  name="ids[]" />
                                        </div>
                                        <div class="matename ">
                                        <label for="check<?php echo $material['lid']; ?>"><?php echo $material['goods_name'];?></label>
                                        </div>
                                </div>
                                <?php $a++;?>
                                <?php endforeach;?>
    ...
    $('#add_matersubmit').on('click',function(){
		...
		if(matenames ){
			...
			if(matids == ''){
				...
				var url = "<?php echo $this->createUrl('storageOrder/ckbatchsave',array('companyId'=>$this->companyId));?>/matids/"+matids+"/lid/"+prodid;
    			$.ajax({
		                   url:url,
		                   type:'POST',
		                   data:matids,//CF
