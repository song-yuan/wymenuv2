...
<div class="page-content">
	...
	<div class="modal fade" id="portlet-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<!-- /.modal-dialog -->
			...
			<!-- BEGIN PAGE HEADER-->
		<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('breadcrumbs'=>array(array('word'=>yii::t('app','微信赠券'),'url'=>$this->createUrl('wechatMarket/list' , array('companyId'=>$this->companyId,'type'=>0,))),array('word'=>yii::t('app','完善资料赠券'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('wechatMarket/list' , array('companyId' => $this->companyId,'type'=>0)))));?>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
		<div class="row">
		...
		<div class="tab-content">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-globe"></i><?php echo yii::t('app','完善资料赠券(*为必填项)');?></div>
					<div class="actions">
					<?php if($model):?>
	...
	$(document).ready(function(){
	    ...
	    $('.staclose').on('click' , function(){
		    ...
		    if($(this).hasClass('close1')){
		    	location.href="<?php echo $this->createUrl('sentwxcardImproinfo/index' , array('companyId'=>$this->companyId));?>/is_new/3";
			 }else if($(this).hasClass('start1')){
			    location.href="<?php echo $this->createUrl('sentwxcardImproinfo/index' , array('companyId'=>$this->companyId));?>/is_new/1";
			 }else if($(this).hasClass('start2')){
			    location.href="<?php echo $this->createUrl('sentwxcardImproinfo/index' , array('companyId'=>$this->companyId));?>/is_new/2";
			 }
