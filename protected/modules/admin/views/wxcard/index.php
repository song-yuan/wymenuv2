		...
		<div class="page-content">
			<!-- BEGIN PAGE HEADER-->
			<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array( 'head'=>yii::t('app','营销管理'),'subhead'=>'微信卡券','breadcrumbs'=>array(array('word'=>'营销管理','url'=>''),array('word'=>'营销品设置','url'=>''),array('word'=>'微信卡券','url'=>''))));?>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div class="row">
										...
										<?php foreach($models as $model):?>
											<tr>
												...
												<td class="button-column">
													<a href="<?php echo $this->createUrl('/admin/wxcard/detail',array('companyId'=>$this->companyId,'id'=>$model['id']));?>" class="btn default btn-xs green-stripe">详情</a>
													<a href="<?php echo $this->createUrl('/admin/wxcard/cardUser',array('companyId'=>$this->companyId,'id'=>$model['id']));?>" class="btn default btn-xs blue-stripe">统计</a>
													<a class="btn default btn-xs red btn_deleteGift" title="删除" cardid="<?php echo $model['id'];?>" href="javascript:;"><i class="fa fa-times"></i> 删 除</a>
												</td>
											</tr>
										<?php endforeach;?>	
										<?php else:?>
