<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('breadcrumbs'=>array(array('word'=>yii::t('app','微信赠券'),'url'=>$this->createUrl('wechatMarket/list' , array('companyId' => $this->companyId,'type'=>0,))),array('word'=>yii::t('app','开卡关怀'),'url'=>$this->createUrl('sentwxcardBeifen/index' , array('companyId' => $this->companyId,))),array('word'=>yii::t('app','设置开卡关怀活动'),'url'=>'')),'back'=>array('word'=>'返回','url'=>$this->createUrl('sentwxcardBeifen/index' , array('companyId' => $this->companyId,)))));?>
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
				...
				'action' => $this->createUrl('sentwxcardBeifen/detailindex' , array('companyId' => $this->companyId,'typeId'=>"product",'promotionID'=>$promotionID)),
        ...
        <div class="tabbable tabbable-custom">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					...
					<div class="caption"><i class="fa fa-globe"></i><?php echo $prodname.yii::t('app','活动产品修改');?></div>
					<div class="actions">						
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						<thead>
							<tr>
								...
								<th style="width:10%"><?php echo yii::t('app','优惠券名称');?></th>
								<th ><?php echo yii::t('app','优惠券面值');?></th>
						...
						<?php foreach ($models as $model):?>
							<tr class="odd gradeX">
								...
								<td style="width:10%"><?php echo $model['cupon_title'];?></td>
								<td ><?php echo $model['cupon_money'];?></td>
								<td ><?php echo $model['min_consumer']?></td>
                                <td ><?php if($model['is_available'])echo '失效';else echo '生效';?></td>
							</tr>
						<?php endforeach;?>
						<?php endif;?>
						</tbody>
	...
	$(document).ready(function(){
      ...
      var layer_zhexiantu = 0;  
        ...
        $("#yichu").on("click",function(){
            ...
            $.ajax({
	            type:'GET',
	 			url:"<?php echo $this->createUrl('sentwxcardBeifen/detaildelete',array('companyId'=>$this->companyId));?>/id/"+str+"/page/",
	 			async: false,
