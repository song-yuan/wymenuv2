				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-reorder"></i><?php echo $prodname.yii::t('app','---设置奖品');?></div>
							<div class="tools">
...
$(document).ready(function(){
	...
	$('#add_save').on('click', function(){
		...
		var url = "<?php echo $this->createUrl('sentwxcardImproinfo/storsentwxcard',array('companyId'=>$this->companyId));?>/plids/"+plids+"/facode/"+facode+"/falid/"+falid;
        $.ajax({
            url:url,
            type:'POST',
            //data:plids,//CF
