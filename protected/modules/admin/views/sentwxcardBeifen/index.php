...
<div class="page-content">
	...
	<div class="modal fade" id="portlet-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<!-- /.modal-dialog -->
			...
			<!-- BEGIN PAGE HEADER-->
		<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('breadcrumbs'=>array(array('word'=>yii::t('app','微信赠券'),'url'=>$this->createUrl('wechatMarket/list' , array('companyId'=>$this->companyId,'type'=>0,))),array('word'=>yii::t('app','开卡关怀'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('wechatMarket/list' , array('companyId' => $this->companyId,'type'=>0)))));?>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
		<div class="row">
		<?php $form=$this->beginWidget('CActiveForm', array(
				'id' => 'privatepromotion-form',
				'action' => $this->createUrl('sentwxcardBeifen/delete' , array('companyId' => $this->companyId,)),
		...
		<div class="tab-content">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-globe"></i><?php echo yii::t('app','开卡关怀');?></div>
					<div class="actions">
						<a href="<?php echo $this->createUrl('sentwxcardBeifen/create' , array('companyId' => $this->companyId));?>" class="btn blue"><i class="fa fa-pencil"></i> <?php echo yii::t('app','设置开卡关怀活动');?></a>
						<div class="btn-group">
				...
				<div class="portlet-body" id="table-manage">
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<?php foreach ($models as $model):?>
								...
								<td class="center">
									<a href="<?php echo $this->createUrl('sentwxcardBeifen/update',array('lid' => $model->lid , 'companyId' => $model->dpid));?>"><?php echo yii::t('app','编辑');?></a>
								</td>
								...
								<td><a href="<?php echo $this->createUrl('sentwxcardBeifen/detailindex',array('lid' => $model->lid , 'companyId' => $model->dpid ,'typeId'=>'product' , 'prodname'=>$model->promotion_title));?>"><?php echo yii::t('app','修改活动产品');?></a></td>
								<td></td>
								</tr>
 ...
 <script type="text/javascript">
	    ...
	    $('.add_btn').on('click', function(){
	        ...
	        $modal.find('.modal-content').load('<?php echo $this->createUrl('sentwxcardBeifen/addprod',array('companyId'=>$this->companyId));?>/pid/'+pid+'/prodname/'+prodname+'/phscode/'+phscode, '', function(){
	          $modal.modal();
	        });
	    });
});
