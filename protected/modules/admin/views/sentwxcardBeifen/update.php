	...
	<!-- BEGIN PAGE -->  
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->   
			<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('breadcrumbs'=>array(array('word'=>yii::t('app','微信赠券'),'url'=>$this->createUrl('wechatMarket/list' , array('companyId' => $this->companyId,'type'=>0,))),array('word'=>yii::t('app','开卡关怀'),'url'=>$this->createUrl('sentwxcardBeifen/index' , array('companyId' => $this->companyId,))),array('word'=>yii::t('app','设置开卡关怀'),'url'=>'')),'back'=>array('word'=>'返回','url'=>$this->createUrl('sentwxcardBeifen/index' , array('companyId' => $this->companyId,)))));?>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div class="row">
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-reorder"></i><?php echo yii::t('app','设置开卡关怀');?></div>
							<div class="tools">
						...
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<?php echo $this->renderPartial('_form', array('model'=>$model,'brdulvs'=>$brdulvs,'userlvs'=>$userlvs)); ?>
							<!-- END FORM--> 
						</div>
					</div>
				</div>
