<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>'退菜理由管理','subhead'=>'退菜理由列表','breadcrumbs'=>array(array('word'=>'退菜理由管理','url'=>''))));?>
		...
		<div class="col-md-12">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-globe"></i>'退菜理由列表</div>
					<div class="actions">
