...
<div class="modal fade" id="portlet-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	...
	<div class="row">
		...
		<?php }else{?>
		<iframe frameborder="0" width= 100% height= 700px src="<?php echo 'https://open-erp.meituan.com/releasebinding?sign='.$sign.'&businessId=2&appAuthToken='.$tokenmodel['appAuthToken'].'&timestamp='.$timestamp;?>"></iframe>
		<?php }?>
		   </div>
		</div>
	</div>
