								...
								<div class="form-body">
									...
									<div class="form-actions fluid">
										<div class="col-md-offset-3 col-md-9">
											...
											<a href="<?php echo $this->createUrl('taste/productTaste' , array('companyId' => $model->dpid,'type' =>2));?>" class="btn default"><?php echo yii::t('app','返回');?></a>                              
										</div>
									</div>
							<?php $this->endWidget(); ?>
							<!-- END FORM--> 
