	<!-- BEGIN PAGE -->  
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->   
			<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('breadcrumbs'=>array(array('word'=>yii::t('app','店铺设置'),'url'=>$this->createUrl('company/list' , array('companyId'=>$this->companyId,'type'=>0,))),array('word'=>yii::t('app','价格体系'),'url'=>$this->createUrl('pricegroup/index' , array('companyId'=>$this->companyId))),array('word'=>yii::t('app','添加价格体系'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('pricegroup/index' , array('companyId'=>$this->companyId)))));?>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><?php echo yii::t('app','添加价格体系');?></div>
						</div>
					</div>
