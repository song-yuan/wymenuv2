		...
		<div class="col-md-12">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					<div class="caption">
						<span class="tab tab-active"><?php echo yii::t('app','价格体系列表');?></span>
					</div>
					<div class="actions">
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<thead>
							<tr>
								...
								<th><?php echo yii::t('app','价格体系名称');?></th>
						...
						<?php foreach ($models as $model):?>
							<tr class="odd gradeX">
                                ...
                                <td class="center">
								<a href="<?php echo $this->createUrl('pricegroup/detailindex',array('pricegroupid' => $model->lid, 'companyId' => $model->dpid));?>"><?php echo yii::t('app','编辑组内价格明细');?></a>
								</td>
							</tr>
						<?php endforeach;?>
						<?php else: ?>
							<tr class="odd gradeX"><td>您还没有添加价格体系,或者,<span style="color:red;">当前选中的不是总部</span>,请点右上角添加</td></tr>
						<?php endif;?>
						</tbody>
					</table>
					</div>
