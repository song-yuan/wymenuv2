									...
									'htmlOptions' => array(
										...
										'enctype' => 'multipart/form-data'
                                            ...
                                            <div class="modal-header">
                                                    ...
                                                    <h4 class="modal-title">绑定PAD信息</h4>
                                            </div>
								...
								<div class="form-body">
										...
										<div class="col-md-4">
											<?php echo $form->dropDownList($model, 'pad_type', array('0' => '收银台' , '1' => '点单PAD','2'=>'开台PAD') , array('class' => 'form-control','placeholder'=>$model->getAttributeLabel('pad_type'),'disabled'=>'disabled'));?>
                                    ...
                                    <div class="modal-footer">
                                            <button type="submit" class="btn blue">解除绑定</button>
