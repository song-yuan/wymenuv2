<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','PAD管理'),'subhead'=>yii::t('app','PAD列表'),'breadcrumbs'=>array(array('word'=>yii::t('app','PAD管理'),'url'=>''),array('word'=>yii::t('app','PAD列表'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('product/list' , array('companyId' => $this->companyId,'type' => '2',)))));?>
