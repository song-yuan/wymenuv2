	<!-- BEGIN PAGE -->  
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->   
			<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('breadcrumbs'=>array(array('word'=>yii::t('app','基础设置'),'url'=>$this->createUrl('product/list' , array('companyId'=>$this->companyId,'type'=>0,))),array('word'=>yii::t('app','地區分组'),'url'=>$this->createUrl('areaGroup/index' , array('companyId'=>$this->companyId))),array('word'=>yii::t('app','添加地區分组'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('areaGroup/index' , array('companyId'=>$this->companyId)))));?>
				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><?php echo yii::t('app','添加地區分组');?></div>
						</div>
					</div>
