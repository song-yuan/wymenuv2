...
<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
		...
		<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('breadcrumbs'=>array(array('word'=>yii::t('app','店铺管理'),'url'=>$this->createUrl('companyset/list' , array('companyId'=>$this->companyId))),array('word'=>yii::t('app','店铺分组及标签'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('companyset/list' , array('companyId'=>$this->companyId)))));?>

	<!-- END PAGE HEADER-->
	<!-- BEGIN PAGE CONTENT-->
	<div class="row">
	<?php $form=$this->beginWidget('CActiveForm', array(
				'id' => 'area-group-delete-form',
				'action' => $this->createUrl('areaGroup/delete' , array('companyId' => $this->companyId)),
	...
	$('#deleted').click(function() {
		if (confirm('删除分组同时也会删除该分组内添加的店铺和仓库')) {
			document.getElementById('area-group-delete-form').submit();
		}
	});
	</script>
	<!-- END PAGE CONTENT-->