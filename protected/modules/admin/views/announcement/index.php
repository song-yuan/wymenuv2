<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('breadcrumbs'=>array(array('word'=>yii::t('app','店铺管理'),'url'=>$this->createUrl('companyset/list' , array('companyId'=>$this->companyId,))),array('word'=>yii::t('app','公告设置'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('companyset/list' , array('companyId' => $this->companyId,)))));?>
	<!-- END PAGE HEADER-->	
	<!-- BEGIN PAGE CONTENT-->
	<div class="row">
	...
	<div class="col-md-12">
			...
			<div class="portlet box purple">
					...
					<div class="caption"><i class="fa fa-globe"></i><?php echo yii::t('app','公告列表');?></div>
					<div class="actions">
						<a href="<?php echo $this->createUrl('announcement/create' , array('companyId' => $this->companyId));?>" class="btn blue"><i class="fa fa-pencil"></i> <?php echo yii::t('app','添加');?></a>
						<div class="btn-group">
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<?php foreach ($models as $model):?>
							<tr class="odd gradeX">                                    
								...
								<td>
								<?php if($model->type == '2'):?>
								<?php switch($model->use_type){
									case 0: echo '';break;
									case 1: echo 'POS端公告';break;
									case 2: echo '微店充值说明';break;
									case 3: echo '微店积分说明';break;
									default: echo '';break;}?>
								<?php endif;?>
								</td>								
								...
								<td class="center">
									<a class="btn btn-sm blue" href="<?php echo $this->createUrl('announcement/update' , array('lid' => $model->lid , 'companyId' => $this->companyId));?>"><?php echo yii::t('app','编辑');?></a>
								</td>
							</tr>
						<?php endforeach;?>
						<?php else:?>
