		...
		<div class="tab-content">
			...
			<div class="portlet box purple">
				...
				<?php if($model && $model->is_available=='0'):?>
                	...
                	<div id="userLevel" style="<?php if($model->to_group!=2){ echo 'display:none ;';}?>" class="form-group ">
                        ...
                        <tr class="odd gradeX">
                         	<td><input type="checkbox" id="<?php echo $i;?>" <?php if($model->group_id==$brdulv->lid){ echo 'checked';}?> class="checkboxes" value="<?php echo $brdulv->lid;?>" name="chk" /></td>
