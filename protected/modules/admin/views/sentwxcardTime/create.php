...
<div class="page-content">
	...
	<div class="modal fade" id="portlet-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<!-- /.modal-dialog -->
			...
			<!-- BEGIN PAGE HEADER-->
		<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('breadcrumbs'=>array(array('word'=>yii::t('app','微信赠券'),'url'=>$this->createUrl('wechatMarket/list' , array('companyId'=>$this->companyId,'type'=>0,))),array('word'=>yii::t('app','定时赠券'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('sentwxcardTime/index' , array('companyId' => $this->companyId)))));?>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
		<div class="row">
		...
		<div class="tab-content">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-globe"></i><?php echo yii::t('app','定时赠券(*为必填项)');?></div>
					<div class="actions">
					</div>
				</div>
		...
		<!-- 			<div class="form-group">
					...
					<div class="form-group">
                        <?php echo $form->label($model, yii::t('app','发券对象'),array('class' => 'col-md-3 control-label'));?>
                        <div class="col-md-4">
                	...
                	<div id="userLevel" style="display:none ;" class="form-group ">
                        ...
                        <input type="hidden" id="hidden1" name="SentwxcardPromotion[group_id]" value="" />
                	</div>
	                <div class="form-group">
                		<i style="color: red;" class="fa  fa-star"></i>
					...
					<div id="" class="form-group ">
                        ...
                        <input type="hidden" id="weekday" name="SentwxcardPromotion[weekday]" value="" />
                	</div>
					<div class="form-group">
						<i style="color: red;" class="fa  fa-star"></i>
 ...
 <script type="text/javascript">
	$(document).ready(function(){
	  	$('#SentwxcardPromotion_to_group').change(function(){ 
	    ...
	    $("#su").on('click',function() {
			...
			var p1 = $('#SentwxcardPromotion_to_group').children('option:selected').val();
