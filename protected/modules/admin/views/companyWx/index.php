				...
				<div class="portlet-title">
					...
					<div class="btn-group">
						...
						<select id="isopen" name="isopen" class="selectedclass">
							...
							<option value="2" <?php if($isopen==2) echo 'selected';?>>堂食</option>
							<option value="3" <?php if($isopen==3) echo 'selected';?>>外卖</option>
							<option value="4" <?php if($isopen==4) echo 'selected';?>>全开</option>
							<option value="5" <?php if($isopen==5) echo 'selected';?>>未开通</option>
						</select>
                    </div>
                    <div class="btn-group">
