...
<div class="page-content">
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
				'id' => 'copyinstruct-form',
				'action' => $this->createUrl('copyinstruct/storeInstruct' , array('companyId' => $this->companyId)),
	...
	<div class="col-md-12">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					...
					<div class="actions">
						<div class="btn-group"> 
							<button type="button" id="su"  class="btn red form-control" ><i class="fa fa-share-square-o "></i> <?php echo yii::t('app','指令下发');?></button>
 						</div> 
					</div>
				</div>
				<div class="portlet-body" id="table-manage">
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						<thead>
							<tr>
								<th style="width:5%" class="table-checkbox"><input type="checkbox" class="group-checkable" data-set="#sample_1 .checkboxes" /><?php echo yii::t('app','全选');?></th>
								<th style="width:25%"><?php echo yii::t('app','指令名称');?></th>
							</tr>
						</thead>
						<tbody>
						<?php if($models) :?>
						<?php foreach ($models as $model):?>
							<tr class="odd gradeX">
								<td><input id="<?php echo $model->lid;?>" type="checkbox" class="checkboxes" value="<?php echo $model->lid;?>" tghs_code="<?php echo $model->phs_code;?>" tgname="<?php echo $model->instruct_name;?>" name="ids[]" />
								</td>
								<td style="width:25%"><?php echo $model->instruct_name;?></td>
							</tr>
						<?php endforeach;?>
						<?php endif;?>
						</tbody>
	...
	$("#su").on('click',function() {
        ...
        if(codep!=''){
        	codep = codep.substr(0,codep.length-1);//除去最后一个“，”
       	 	...
       	 	alert("<?php echo yii::t('app','请选择要下发的指令！！！');?>");
       		return false;
       	}
       	if(name){
