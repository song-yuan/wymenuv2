...
<div class="page-content">
    ...
    <!-- BEGIN PAGE HEADER-->
    <?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('breadcrumbs'=>array(array('word'=>yii::t('app','微信会员'),'url'=>$this->createUrl('company/list' , array('companyId'=>$this->companyId))),array('word'=>yii::t('app','自定义菜单'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('wechatMember/list' , array('companyId' => $this->companyId,)))));?>
    <!-- END PAGE HEADER-->
    <!-- BEGIN PAGE CONTENT-->
                                ...
                                <div class="caption">
                                   <i class="fa fa-cogs"></i>
                                    <a href="<?php echo $this->createUrl('weixin/index',array('companyId'=>$this->companyId));?>">
                                        <span class="tab">
                                            <?php echo yii::t('app','公众号设置');?>
                                        </span>
                                    </a>
                                    <span class="tab tab-active">
                                        <?php echo yii::t('app','自定义菜单');?>
                                    </span>
                                </div>
                            </div>-->
                                ...
                                <div class="table-responsive">
                                     <form id="Menu" action="<?php echo $this->createUrl('/admin/weixin/menu',array('companyId'=>$this->companyId));?>" method="post">
                                                        ...
                                                        <table class="table table-bordered table-hover">
                                                            ...
                                                            <tbody class="menu_level menu_level1-<?php echo $level;?>">
                                                                <tr class="level1" horizontal="<?php echo $menu['horizontal'];?>" vertical="0">
                                                                    <td width="5%">
                                                                        <input type="hidden" name="menu[<?php echo $maxnum;?>][h]" value="<?php echo $level;?>"/>
                                                                        <input type="hidden" name="menu[<?php echo $maxnum;?>][v]" value="0"/>
                                                                        <input type="text" class="form-control menu_name" name="menu[<?php echo $maxnum;?>][name]" value="<?php echo $menu['name'];?>" placeholder="一级菜单名"  maxlength="4" />
                                                                    </td>
                                                                    <td width="10%">
                                                                        <input type="text" class="form-control menu_val" name="menu[<?php echo $maxnum;?>][value]" value="<?php echo $menu['value'];?>" placeholder="一级菜单链接" />
                                                                    </td>
                                                                    <td width="4%">
                                                                        <select class="form-control type" name="menu[<?php echo $maxnum;?>][type]">
                                                                            <option <?php echo ($menu['type']==0)?"selected":"";?>  value="0">有子菜单</option>
                                                                            <option <?php echo ($menu['type']==1)?"selected":"";?> value="1">跳转网址</option>
                                                                            <!--<option <?php echo ($menu['type']==2)?"selected":"";?> value="2">事件推送</option>-->
                                                                        </select>
                                                                    </td>
                                                                    <td width="2%">
                                                                        <a class="btn btn-xs green add_btn add_level2" level="<?php echo $level;?>">
                                                                            <i class="fa fa-plus"></i>
                                                                        </a>
                                                                        <?php if($menu['horizontal']!=0) echo '&nbsp;&nbsp;<a class="btn btn-xs red del_level1_btn" level="'.$level.'"><i class="fa fa-times"></i></a>'; ?>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr class="level2" horizontal="<?php echo $children['horizontal'];?>" vertical="<?php echo $children['vertical'];?>">
                                                                    <td width="5%">
                                                                        <input class="h" type="hidden" name="menu[<?php echo $maxnum;?>][h]" value="<?php echo $children['horizontal'];?>">
                                                                        <input class="v" type="hidden" name="menu[<?php echo $maxnum;?>][v]" value="<?php echo $children['vertical'];?>">
                                                                        <input type="text" class="form-control menu_name" name="menu[<?php echo $maxnum;?>][name]" maxlength="7" value="<?php echo $children['name'];?>" placeholder="子菜单名"  maxlength="7" />
                                                                    </td>
                                                                    <td width="10%">
                                                                        <input type="text" class="form-control" name="menu[<?php echo $maxnum;?>][value]" value="<?php echo $children['value'];?>" placeholder="子菜单链接" />
                                                                    </td>
                                                                    <td width="4%">
                                                                        <select class="form-control type" name="menu[<?php echo $maxnum;?>][type]">
                                                                            <option <?php echo ($children['type']==1)?"selected":"";?> value="1">跳转网址</option>
                                                                            <!--<option <?php echo ($children['type']==2)?"selected":"";?> value="2">事件推送</option>-->
                                                                        </select>
                                                                    </td>
                                                                    <td width="2%">
                                                                        <a class="btn btn-xs red del_level2_btn" level="<?php echo $children['horizontal'];?>">
                                                            ...
                                                            <tbody class="menu_level menu_level1-0">
                                                                <tr class="level1" horizontal="0" vertical="0">
                                                                    <td width="5%">
                                                                        <input type="hidden" name="menu[0][h]" value="0"/>
                                                                        <input type="hidden" name="menu[0][v]" value="0"/>
                                                                        <input type="text" class="form-control menu_name" name="menu[0][name]" value="<?php echo isset($menuList[0]['name'])?$menuList[0]['name']:'';?>" placeholder="一级菜单名"  maxlength="4" />
                                                                    </td>
                                                                    <td width="10%">
                                                                        <input type="text" class="form-control menu_val" name="menu[0][value]" value="<?php echo isset($menuList[0]['value'])?$menuList[0]['value']:'';?>" placeholder="一级菜单链接" />
                                                                    </td>
                                                                    <td width="4%">
                                                                        <select class="form-control type" name="menu[0][type]">
                                                                            <option selected  value="0">有子菜单</option>
                                                                            <option value="1">跳转网址</option>
                                                                        </select>
                                                                    </td>
                                                                    <td width="2%">
                                                                        <a class="btn btn-xs green add_btn add_level2" level="0">
                                                                            <i class="fa fa-plus"></i>
                                                                        </a>
                                                                    </td>
                                                                </tr>
                                            ...
                                            <div class="alert alert-warning">
                                                    <strong>注意:</strong>
                                                    创建自定义菜单后，需要24小时微信客户端才会展现出来。请慎重发布菜单!</br></br>
                                            </div>
                                        </form>
                                    </div>
                                </div>
