...
//		});
                ...
                $(".consumelist").on("click",function(){
                    ...
                    modalconsumetotal=$('#portlet-consume');
                        totalurl='<?php echo $this->createUrl('weixin/consumelist',array('companyId'=>$this->companyId));?>/lid/'+lid;
                ...
                $(".pointlist").on("click",function(){
                    var lid=$(this).attr("data-id");
                    modalconsumetotal=$('#portlet-consume');
                        totalurl='<?php echo $this->createUrl('weixin/pointlist',array('companyId'=>$this->companyId));?>/lid/'+lid;
                        modalconsumetotal.find('.modal-content').load(totalurl
                        ,'', function(){
                          modalconsumetotal.modal();
                    });
                ...
                $(".branduserdetail").on("click",function(){
                    ...
                    modalconsumetotal=$('#portlet-consume');
                        totalurl='<?php echo $this->createUrl('weixin/branduserdetail',array('companyId'=>$this->companyId));?>/lid/'+lid+'/wg/'+wg+'/ul/'+ul;
                        modalconsumetotal.find('.modal-content').load(totalurl
                        ,'', function(){
                          modalconsumetotal.modal();
                    });
