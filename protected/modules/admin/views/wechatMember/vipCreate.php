...
<?php $this->widget(
                    ...
                    array(
                        'breadcrumbs'=>array(
                                            ...
                                            array('word'=>yii::t('app','添加VIP等级'),'url'=>'')
                                            ),
                        'back'=>array(
                                    'word'=>yii::t('app','返回'),
                                    'url'=>$this->createUrl('wechatMember/vip' , array('companyId' => $this->companyId,))
                                ...
                                <div class="row">
                                    ...
                                    <?php if($member_wxcard_bgimgs):?>
                                         ...
                                         <?php foreach ($member_wxcard_bgimgs as $bgimg):?>
                                         	...
                                         	<div class="wxcardchecked uhine"><img width="50px" style="margin-left: 60px;" src="../../../../img/checked.png"/></div>
                                         	</div>
                                         <?php endforeach;?>
                                         </div>
                                    <?php else:?>
                                        <div style="width: 50% !important;" class="form-group">                                    
                                          	<a href="<?php echo $this->createUrl('wxCardStyle/index',array('companyId' => $this->companyId,));?>" style="color: red;">请先添加会员卡样式，否则添加失败。</a>
                                        </div>
                                    <?php endif;?>
