							<?php $form=$this->beginWidget('CActiveForm', array(
								...
								<?php if(!$model->dpid):?>
									<div class="form-group">
										...
										<div class="col-md-4">
											<?php echo $form->dropDownList($model, 'dpid', array_merge(array('0' => "<?php echo yii::t('app','-- 请选择 --');?>") , Helper::genCompanyOptions()) ,array('class' => 'form-control','placeholder'=>$model->getAttributeLabel('dpid')));?>
								...
								<?php endif;?>
									...
									<div class="form-actions fluid">
										<div class="col-md-offset-3 col-md-9">
											...
											<a href="<?php echo $this->createUrl('floor/index' , array('companyId' => $model->dpid));?>" class="btn default">返回</a>                              
										</div>
									</div>
							<?php $this->endWidget(); ?>