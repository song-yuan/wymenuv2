<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','库存综合查询'),'subhead'=>yii::t('app','查询列表'),'breadcrumbs'=>array(array('word'=>yii::t('app','库存综合查询'),'url'=>''))));?>
			...
			<div class="portlet box purple">
				...
				<div class="portlet-body" id="table-manage">
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						<thead>
							<tr>
								<th><?php echo yii::t('app','品项类别');?></th>
								<th><?php echo yii::t('app','品项名称');?></th>
								<th><?php echo yii::t('app','期初库存');?></th>
								<th><?php echo yii::t('app','进货数量');?></th>
								<th><?php echo yii::t('app','销售数量');?></th>
								<th><?php echo yii::t('app','调拨数量');?></th>
								<th><?php echo yii::t('app','退货数量');?></th>
								<th><?php echo yii::t('app','期末库存');?></th>
							</tr>
						</thead>
						<tbody>
						<?php //if($models) :?>
