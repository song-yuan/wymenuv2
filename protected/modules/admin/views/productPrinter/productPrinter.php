<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>'单品打印方式管理','subhead'=>'单品打印方式列表','breadcrumbs'=>array(array('word'=>'产品口味对应','url'=>''))));?>
		...
		<div class="col-md-12">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-globe"></i>单品打印方式列表</div>
				</div>
