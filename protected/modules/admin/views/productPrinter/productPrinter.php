<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','单品打印方式管理'),'subhead'=>yii::t('app','单品打印方式列表'),'breadcrumbs'=>array(array('word'=>yii::t('app','产品口味对应'),'url'=>''))));?>
