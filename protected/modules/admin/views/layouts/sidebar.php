				...
				<li class="<?php if(in_array(Yii::app()->controller->id , array('' , ''))) echo 'active';?>">
					...
					<ul class="sub-menu">
						...
						<li class="<?php if(Yii::app()->controller->id == 'statements' && $this->getAction()->getId() == 'orderReport') echo 'active';?>"><a href="<?php echo $this->createUrl('statements/orderReport',array('companyId' => $this->companyId,'text'=>'1','begin_time'=>date('Y-m-d',time()),'end_time'=>date('Y-m-d',time()),'page'=>1));?>"><?php echo yii::t('app','订单统计报表');?></a></li>
						 -->
						<li class="<?php if(Yii::app()->controller->id == 'statements' && $this->getAction()->getId() == 'payallReport') echo 'active';?>"><a href="<?php echo $this->createUrl('statements/payallReport',array('companyId' => $this->companyId,'text'=>'1','begin_time'=>date('Y-m-d',time()),'end_time'=>date('Y-m-d',time()),'page'=>1));?>"><?php echo yii::t('app','收款统计(支付方式)');?></a></li>
						<li class="<?php if(Yii::app()->controller->id == 'statements' && $this->getAction()->getId() == 'incomeReport') echo 'active';?>"><a href="<?php echo $this->createUrl('statements/incomeReport',array('companyId' => $this->companyId,'text'=>'1','begin_time'=>date('Y-m-d',time()),'end_time'=>date('Y-m-d',time()),'page'=>1));?>"><?php echo yii::t('app','营业收入(产品分类)');?></a></li>
						...
						<li class="<?php if(Yii::app()->controller->id == 'statements' && $this->getAction()->getId() == 'ceshiproductReport') echo 'active';?>"><a href="<?php echo $this->createUrl('statements/ceshiproductReport',array('companyId' => $this->companyId,'text'=>'1','ordertype'=>'0','begin_time'=>date('Y-m-d',time()),'end_time'=>date('Y-m-d',time()),'page'=>1));?>"><?php echo yii::t('app','产品销售报表');?></a></li>
						<li class="<?php if(Yii::app()->controller->id == 'statements' && $this->getAction()->getId() == 'orderdetail') echo 'active';?>"><a href="<?php echo $this->createUrl('statements/orderdetail',array('companyId' => $this->companyId,'text'=>'1','begin_time'=>date('Y-m-d',time()),'end_time'=>date('Y-m-d',time()),'page'=>1));?>"><?php echo yii::t('app','账单详情报表');?></a></li>
						<li class="<?php if(Yii::app()->controller->id == 'statements' && $this->getAction()->getId() == 'businessdataReport') echo 'active';?>"><a href="<?php echo $this->createUrl('statements/businessdataReport',array('companyId' => $this->companyId,'text'=>'1','begin_time'=>date('Y-m-d',time()),'end_time'=>date('Y-m-d',time()),'page'=>1));?>"><?php echo yii::t('app','营业数据报表');?></a></li>
						<li class="<?php if(Yii::app()->controller->id == 'statements' && $this->getAction()->getId() == 'channelsproportion') echo 'active';?>"><a href="<?php echo $this->createUrl('statements/channelsproportion',array('companyId' => $this->companyId,'text'=>'1','begin_time'=>date('Y-m-d',time()),'end_time'=>date('Y-m-d',time()),'page'=>1));?>"><?php echo yii::t('app','渠道占比报表');?></a></li>
						<li class="<?php if(Yii::app()->controller->id == 'statements' && $this->getAction()->getId() == 'retreatdetailReport') echo 'active';?>"><a href="<?php echo $this->createUrl('statements/retreatdetailReport',array('companyId' => $this->companyId,'text'=>'1','begin_time'=>date('Y-m-d',time()),'end_time'=>date('Y-m-d',time()),'page'=>1));?>"><?php echo yii::t('app','退菜明细报表');?></a></li>
						<li class="<?php if(Yii::app()->controller->id == 'statements' && $this->getAction()->getId() == 'retreatreasonReport') echo 'active';?>"><a href="<?php echo $this->createUrl('statements/retreatreasonReport',array('companyId' => $this->companyId,'text'=>'1','begin_time'=>date('Y-m-d',time()),'end_time'=>date('Y-m-d',time()),'page'=>1));?>"><?php echo yii::t('app','退菜原因统计报表');?></a></li>
