			...
			<ul class="page-sidebar-menu">
				...
				<li class="<?php if(in_array(Yii::app()->controller->id , array('' , ''))) echo 'active';?>">
					...
					<ul class="sub-menu">
						...
						<li class="<?php if(Yii::app()->controller->id == 'statements' && $this->getAction()->getId() == 'recharge') echo 'active';?>"><a href="<?php echo $this->createUrl('statements/recharge',array('companyId' => $this->companyId,'text'=>'1','begin_time'=>date('Y-m-d',time()),'end_time'=>date('Y-m-d',time()),'page'=>1));?>"><?php echo yii::t('app','充值记录');?></a></li>
