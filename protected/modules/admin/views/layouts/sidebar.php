...
>>>>>>> b0b0dc50c66ce3f076d9cb26351f494609b869d7
                                ...
                                <li class="<?php if(in_array(Yii::app()->controller->id , array('cashcard','normalpromotion','wxRedpacket','privatepromotion','cupon'))) echo 'active';?>">
					<a href="">
					<i class="fa fa-comments"></i> 
					<span class="title"><?php echo yii::t('app','营销管理');?></span>
					</a>
					<ul class="sub-menu">
						<li class="<?php if(Yii::app()->controller->id == 'cashcard' ||'normalpromotion' ||'privatepromotion'||'cupon' && in_array($this->getAction()->getId(),array('index','create','update'))) echo 'active';?>"><a href="<?php echo $this->createUrl('cashcard/index',array('companyId' => $this->companyId));?>"><?php echo yii::t('app','营销品设置');?></a></li><!--整体设置，普通优惠、专享优惠、代金券-->
                        ...
                        <!-- <li class="<?php if(Yii::app()->controller->id == 'cashcard' && in_array($this->getAction()->getId(),array('update'))) echo 'active';?>"><a href="<?php echo $this->createUrl('cashcard/update',array('companyId' => $this->companyId));?>"><?php echo yii::t('app','营销活动');?></a></li><!--营销活动管理，添加营销品-->
