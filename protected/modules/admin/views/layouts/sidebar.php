			...
			<ul class="page-sidebar-menu">
				...
				<li class="<?php if(in_array(Yii::app()->controller->id , array('company' ,'payMethod', 'companyWifi', 'user'))) echo 'active';?>">
					...
					<ul class="sub-menu">
						...
						<li class="<?php if(Yii::app()->controller->id == 'productImg') echo 'active';?>"><a href="<?php echo $this->createUrl('productImg/index',array('companyId' => $this->companyId));?>"><?php echo yii::t('app','产品图片管理');?></a></li>
                                                <li class="<?php if(Yii::app()->controller->id == 'productPrinter') echo 'active';?>"><a href="<?php echo $this->createUrl('productPrinter/index',array('companyId' => $this->companyId));?>"><?php echo yii::t('app','单品打印方式管理');?></a></li>
				...
				<li class="<?php if(in_array(Yii::app()->controller->id , array('site' , 'siteType', 'floor'))) echo 'active';?>">
					...
					<ul class="sub-menu">
						...
						<li class="<?php if(Yii::app()->controller->id == 'siteType') echo 'active';?>"><a href="<?php echo $this->createUrl('siteType/index',array('companyId' => $this->companyId));?>"><?php echo yii::t('app','餐桌种类');?></a></li>
				...
				<li class="<?php if(in_array(Yii::app()->controller->id , array('printer' , 'printerWay', 'pad'))) echo 'active';?>">
					...
					<ul class="sub-menu">
						...
						<li class="<?php if(Yii::app()->controller->id == 'printerWay') echo 'active';?>"><a href="<?php echo $this->createUrl('printerWay/index',array('companyId' => $this->companyId));?>"><?php echo yii::t('app','打印方案');?></a></li>
				...
				<li class="<?php if(in_array(Yii::app()->controller->id , array('' , ''))) echo 'active';?>">
					...
					<ul class="sub-menu">
						...
						<li class=""><a href=""><?php echo yii::t('app','产品销售报表');?></a></li>
						<li class=""><a href=""><?php echo yii::t('app','订单统计报表');?></a></li>
					</ul>
				</li>
				<!--
