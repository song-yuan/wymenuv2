			...
			<ul class="page-sidebar-menu">
				...
				<li class="<?php if(in_array(Yii::app()->controller->id , array('orderManagement'))) echo 'active';?>">
					...
					<ul class="sub-menu">
                        ...
                        <li class="<?php if(Yii::app()->controller->id == 'screen' && in_array($this->getAction()->getId(),array('index','create','update'))) echo 'active';?>"><a href="<?php echo $this->createUrl('screen/index',array('companyId' => $this->companyId));?>"><?php echo yii::t('app','微信电视');?></a></li><!--弹幕电视-->
