			...
			<ul class="page-sidebar-menu">
				...
				<li class="<?php if(in_array(Yii::app()->controller->id , array('' , ''))) echo 'active';?>">
					...
					<ul class="sub-menu">
						...
						<li class="<?php if(Yii::app()->controller->id == 'statements' && $this->getAction()->getId() == 'businessdataReport') echo 'active';?>"><a href="<?php echo $this->createUrl('statements/businessdataReport',array('companyId' => $this->companyId,'text'=>'1','begin_time'=>date('Y-m-d h:i:s',time()),'end_time'=>date('Y-m-d h:i:s',time()),'page'=>1));?>"><?php echo yii::t('app','营业数据报表');?></a></li>
						<li class="<?php if(Yii::app()->controller->id == 'statements' && $this->getAction()->getId() == 'retreatdetailReport') echo 'active';?>"><a href="<?php echo $this->createUrl('statements/retreatdetailReport',array('companyId' => $this->companyId,'text'=>'1','begin_time'=>date('Y-m-d h:i:s',time()),'end_time'=>date('Y-m-d h:i:s',time()),'page'=>1));?>"><?php echo yii::t('app','退菜明细报表');?></a></li>
					</ul>
				</li>                                
