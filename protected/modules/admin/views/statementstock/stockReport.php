					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<tbody>
							...
							?>
								...
								<td><?php  $takingstock = $model['taking_stock']; echo $model['all_storagestock'];?></td>
								<td><?php echo '';?></td>
								<td><?php echo '';?></td>
								<td><?php $demagestock = $model['demage_stock']; echo $demagestock;?></td>
								<td><?php $salestock = $model['sales_stocks']; echo $salestock;?></td>
								<td><?php $usestock = $demagestock+$laststock+$allstoragestock-$takingstock; echo $usestock;?></td>
								<td><?php echo $takingstock;?></td>
								<td><?php echo $model['taking_stock'];?></td>
								<td><?php echo $model['all_sunyi_num'];?></td>
							<?php $a++;?>
							<?php endforeach;?>	
							<!-- end foreach-->
							<?php else:?>
