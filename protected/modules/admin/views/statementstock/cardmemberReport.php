	...
	<div class="col-md-12">
			...
			<div class="portlet box purple">
				...
				<div class="actions">
					...
					<option value="m" <?php if ($sex=='m'){?> selected="selected" <?php }?> ><?php echo yii::t('app','男');?></option>
					<option value="f" <?php if ($sex=='f'){?> selected="selected" <?php }?> ><?php echo yii::t('app','女');?></option>
					</select>
				<div class="btn-group">
	...
	if(xAxisname){
		...
		jQuery(document).ready(function(){
		   ...
		   $('#btn_time_query').click(function time() {
			   ...
			   var text = $('#text').val();
			   var sex = $('#sex').val();
			   location.href="<?php echo $this->createUrl('statementmember/cardmemberReport' , array('companyId'=>$this->companyId ));?>/begin_time/"+begin_time+"/end_time/"+end_time+"/text/"+text+"/sex/"+sex;    
	        });
		   $('#cx').click(function cx(){
				...
				//alert(str);
					 ...
					 location.href="<?php echo $this->createUrl('statementmember/cardmemberReport' , array('companyId'=>$this->companyId ));?>/str/"+str+"/begin_time/"+begin_time+"/end_time/"+end_time +"/text/"+text+"/setid/"+setid;	  
					 //return a; 
			 });
			  ...
			  $('#excel').click(function excel(){
			       ...
			       if(confirm('确认导出并且下载Excel文件吗？')){
				       //layer.msg('暂未开放！');
			    	   location.href="<?php echo $this->createUrl('statementmember/cardmemberExport' , array('companyId'=>$this->companyId ));?>/begin_time/"+begin_time+"/end_time/"+end_time +"/text/"+text+"/sex/"+sex;
			       }
			       else{
			    	   location.href="<?php echo $this->createUrl('statementmember/cardmemberReport' , array('companyId'=>$this->companyId ));?>/str/"+str+"/begin_time/"+begin_time+"/end_time/"+end_time +"/text/"+text;
			       }
