	...
	<!-- BEGIN PAGE --> 	
		...
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->   
			<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array( 'head'=>yii::t('app','营销管理'),'subhead'=>yii::t('app','特价优惠查询'),'breadcrumbs'=>array(array('word'=>yii::t('app','营销管理'),'url'=>''),array('word'=>yii::t('app','营销品设置'),'url'=>''),array('word'=>yii::t('app','添加特价优惠活动'),'url'=>'')),'back'=>array('word'=>'返回','url'=>$this->createUrl('privatepromotion/index' , array('companyId' => $this->companyId,)))));?>
