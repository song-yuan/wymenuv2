<div class="page-content">
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
				...
				'action' => $this->createUrl('privatepromotion/detailindex' , array('companyId' => $this->companyId,'typeId'=>"product",'promotionID'=>$promotionID)),
	...
	<div class="col-md-12">
                    ...
                    <div class="tabbable tabbable-custom">
                            <ul class="nav nav-tabs">
                                    <li class="<?php if($typeId == 'product') echo 'active' ; ?>"><a href="#tab_1_<?php echo $typeId;?>" data-toggle="tab" onclick="location.href='<?php echo $this->createUrl('privatepromotion/detailindex' , array('typeId'=>'product' , 'companyId'=>$this->companyId,'promotionID'=>$promotionID));?>'"><?php echo yii::t('app','单品');?></a></li>
                                    <li class="<?php if($typeId == 'set') echo 'active' ; ?>"><a href="#tab_1_<?php echo $typeId;?>" data-toggle="tab" onclick="location.href='<?php echo $this->createUrl('privatepromotion/detailindex' , array('typeId'=>'set' , 'companyId'=>$this->companyId,'promotionID'=>$promotionID));?>'"><?php echo yii::t('app','套餐');?></a></li>
				...
				<div class="portlet-title">
					...
					<div class="actions">						
						...
						<div class="btn-group" style="left:3%;">
							<a href="<?php echo $this->createUrl('privatepromotion/promotiondetail' , array('companyId' => $this->companyId ,'promotionID'=>$promotionID));?>" class="btn blue" style="padding:7px 10px;margin-top:2px;"><?php echo yii::t('app','查看已添加菜品');?></a>
						</div>
	...
	$(document).ready(function(){
		...
		$('.s-btn').on('switch-change', function () {
                    var inp = $(this).find('input');
                        ...
                        var url='<?php echo $this->createUrl('privatepromotion/status',array('companyId'=>$this->companyId));?>/id/'+id+'/typeId/'+typeid;
                        //alert(url);
                        $.get(url);
		});
