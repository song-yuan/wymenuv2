	...
	$(document).ready(function(){
        ...
        $(".clear_btn").on("click",function(){
           ...
           // alert(checkvalue);
            ...
            $.ajax({
                        type:'GET',
 			url:"<?php echo $this->createUrl('privatepromotion/store',array('companyId'=>$this->companyId));?>/id/"+vid+"/promotionID/"+promotionID+"/proNum/"+optvalue+"/proID/"+optid+"/cid/"+cid+"/page/",
 			async: false,
 			//data:"companyId="+company_id+'&padId='+pad_id,
                        cache:false,
                        dataType:'json',
