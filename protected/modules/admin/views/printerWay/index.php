<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>'打印机管理','subhead'=>'打印机方式列表','breadcrumbs'=>array(array('word'=>'打印机方式管理','url'=>''),array('word'=>'打印机方式管理','url'=>''))));?>
