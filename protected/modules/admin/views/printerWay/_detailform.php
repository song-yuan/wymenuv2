							<?php $form=$this->beginWidget('CActiveForm', array(
								...
								<?php endif;?>
										...
										<div class="col-md-4">
											...
											<?php echo $form->error($model, 'list_no' )?>小于127
										</div>
									</div>
									<div class="form-actions fluid">
										<div class="col-md-offset-3 col-md-9">
											<button type="submit" class="btn blue">确定</button>
											<a href="<?php echo $this->createUrl('printerway/detailindex' , array('companyId' => $model->dpid,'lid' => $model->print_way_id));?>" class="btn default">返回</a>                              
										</div>
									</div>
							<?php $this->endWidget(); ?>