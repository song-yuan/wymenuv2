<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>"<?php echo yii::t('app','订单管理');?>",'subhead'=>"<?php echo yii::t('app','订单列表');?>",'breadcrumbs'=>array(array('word'=>"<?php echo yii::t('app','订单管理');?>",'url'=>''),array('word'=>"<?php echo yii::t('app','订单管理');?>",'url'=>''))));?>
						...
						<thead>
							<tr>
								...
								<th><?php echo yii::t('app','座号');?></th>
                                                                <th><?php echo yii::t('app','下单菜品');?></th>
								<th><?php echo yii::t('app','开台时间');?></th>
								<th><?php echo yii::t('app','结单时间');?></th>
