					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<?php foreach ($models as $model):?>
							<tr class="odd gradeX">
								...
								<td class="center">
								<a href="<?php echo $this->createUrl('/admin/purchaseOrderDetail/index',array('id' => $model->lid , 'companyId' => $model->dpid));?>"><?php echo yii::t('app','订单详情');?></a>
								</td>
								<td class="center">
