	...
	<!-- BEGIN PAGE --> 	
		...
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->   
			<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array( 'head'=>yii::t('app','营销管理'),'subhead'=>yii::t('app','修改折扣模板'),'breadcrumbs'=>array(array('word'=>yii::t('app','营销管理'),'url'=>''),array('word'=>yii::t('app','折扣模板设置'),'url'=>''),array('word'=>yii::t('app','修改折扣缪版'),'url'=>''))));?>
