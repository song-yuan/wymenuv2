<div class="page-content">
	...
	<div class="col-md-12">
			...
			<div class="portlet box purple">
					...
					<div class="actions">
						...
						<div class="btn-group">
							<button type="button"  class="btn pink ceshi" ><i class="fa fa-ban"></i> <?php echo yii::t('app','测试');?></button>
						</div>
					</div>
				</div>
	...
	$('.ceshi').on('click',function(){alert(111);
		$.ajax({
