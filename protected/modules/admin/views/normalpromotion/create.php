	...
	<!-- BEGIN PAGE --> 	
		...
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->   
			<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array( 'head'=>yii::t('app','营销管理'),'subhead'=>'普通优惠查询','breadcrumbs'=>array(array('word'=>'营销管理','url'=>''),array('word'=>'营销品设置','url'=>''),array('word'=>'添加普通优惠活动','url'=>'')),'back'=>array('word'=>'返回','url'=>$this->createUrl('normalpromotion/index' , array('companyId' => $this->companyId,)))));?>
