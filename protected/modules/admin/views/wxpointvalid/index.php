<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','微信会员设置'),'subhead'=>yii::t('app','积分有效期设置'),'breadcrumbs'=>array(array('word'=>yii::t('app','微信会员设置'),'url'=>''))));?>
