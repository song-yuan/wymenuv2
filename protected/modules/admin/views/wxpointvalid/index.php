<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','微信会员设置'),'subhead'=>yii::t('app','积分有效期设置'),'breadcrumbs'=>array(array('word'=>yii::t('app','微信会员设置'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('member/list' , array('companyId' => $this->companyId,'type'=>0)))));?>
	...
	<div class="row">
            <div class="col-md-12 col-sm-12">
                    <ul class="nav nav-tabs">
                            ...
                            <li class="active"><a href="javascript:;" onclick="location.href='<?php echo $this->createUrl('/admin/wxpointvalid/index',array('companyId'=>$this->companyId));?>'" data-toggle="tab">积分有效期模板</a></li>
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
				...
				'action' => $this->createUrl('wxpointvalid/delete' , array('companyId' => $this->companyId)),
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<?php foreach ($models as $model):?>
							<tr class="odd gradeX">
								...
								<td ><?php echo $model->valid_name;?></td>
								<td ><?php echo $model->valid_days;?></td>
                                                                <td>
                                                                        <?php if($model->is_available) {echo '否';} else {echo '是';} ?>
								</td>
								<td class="center">
								<a href="<?php echo $this->createUrl('wxpointvalid/update',array('lid' => $model->lid , 'companyId' => $model->dpid));?>"><?php echo yii::t('app','编辑');?></a>
								</td>
							</tr>
						<?php endforeach;?>
						<?php endif;?>
