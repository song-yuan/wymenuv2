	<!-- BEGIN PAGE -->  
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER--> 
			<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','基础设置'),'subhead'=>yii::t('app','添加指令明细'),'breadcrumbs'=>array(array('word'=>yii::t('app','基础设置'),'url'=>$this->createUrl('product/list' , array('companyId'=>$this->companyId))),array('word'=>yii::t('app','指令设置'),'url'=>$this->createUrl('instruct/index' , array('companyId'=>$this->companyId))),array('word'=>yii::t('app','指令明细列表'),'url'=>$this->createUrl('instruct/detailIndex' , array('companyId' => $model->dpid,'groupid'=>$groupid))),array('word'=>yii::t('app','添加指令明细'),'url'=>''))));?>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div class="row">
				<div class="col-md-12">
