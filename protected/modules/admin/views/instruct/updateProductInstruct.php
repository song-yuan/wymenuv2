...
<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->   
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('breadcrumbs'=>array(array('word'=>yii::t('app','基础设置'),'url'=>$this->createUrl('product/list' , array('companyId'=>$this->companyId,'type'=>0,))),array('word'=>yii::t('app','单品指令对应'),'url'=>$this->createUrl('instruct/productInstruct/' , array('companyId'=>$this->companyId))),array('word'=>yii::t('app','产品指令对应'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('instruct/productInstruct/' , array('companyId'=>$this->companyId)))));?>
