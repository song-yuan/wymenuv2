	...
	$(document).ready(function(){
	    ...
	    $('.staclose').on('click' , function(){
		    ...
		    if($(this).hasClass('close1')){
		    	location.href="<?php echo $this->createUrl('sentwxcardBirthday/index' , array('companyId'=>$this->companyId));?>/is_new/3";
			 }else if($(this).hasClass('start1')){
			    location.href="<?php echo $this->createUrl('sentwxcardBirthday/index' , array('companyId'=>$this->companyId));?>/is_new/1";
			 }else if($(this).hasClass('start2')){
			    location.href="<?php echo $this->createUrl('sentwxcardBirthday/index' , array('companyId'=>$this->companyId));?>/is_new/2";
			 }
