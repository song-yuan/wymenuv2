...
<div class="page-content">
	...
	<div class="modal fade" id="portlet-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('breadcrumbs'=>array(array('word'=>yii::t('app','微信赠券'),'url'=>$this->createUrl('wechatMarket/list' , array('companyId'=>$this->companyId,'type'=>0,))),array('word'=>yii::t('app','生日赠券'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('wechatMarket/list' , array('companyId' => $this->companyId,'type'=>0)))));?>
		<!-- END PAGE HEADER-->
		<!-- BEGIN PAGE CONTENT-->
	<div class="row">
	<?php $form=$this->beginWidget('CActiveForm', array(
			'id' => 'sentwxcardpromotion-form',
			'action'=>$this->createUrl('sentwxcardBirthday/delete',array('companyId'=>$this->companyId)),
			...
			<div class="tab-content">
				...
				<div class="portlet box purple">
					<div class="portlet-title">
						<div class="caption"><i class="fa fa-globe"></i><?php echo yii::t('app','生日赠券列表');?></div>
						<div class="actions">
							<div class="btn-group">
								<a href=" <?php echo $this->createUrl('sentwxcardBirthday/create',array('companyId'=>$this->companyId)) ?>" class="staclose btn blue"><i class="fa fa-pencil"></i> <?php echo yii::t('app','添加');?></a>
							</div>
							<div class="btn-group">
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<?php foreach ($models as $model):?>
							<tr class="odd gradeX">
								...
								<td class="center"><a href=" <?php echo $this->createUrl('sentwxcardBirthday/update',array('companyId'=>$this->companyId,'lid'=>$model->lid)) ?>" class="btn blue">编辑</a>
								<a href=" <?php echo $this->createUrl('sentwxcardBirthday/update',array('companyId'=>$this->companyId,'lid'=>$model->lid,'show'=>1)) ?>" class="btn yellow">查看详情</a>
							</tr>
						<?php endforeach;?>
						<?php endif;?>
						</tbody>
