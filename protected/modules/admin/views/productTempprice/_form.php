								...
								<div class="form-body">
									...
									<div class="form-group discount">
										...
										<div class="col-md-4">
											...
											<input type="text" class="form-control" name="ProductTempprice[price]" value="<?php echo $model->price;?>" /><span class="input-group-addon">元</span> <?php echo '原价： '.$product->original_price;?>
											</div>
										</div>
									</div>
									...
									<div class="form-actions fluid">
										<div class="col-md-offset-3 col-md-9">
											...
											<a href="<?php echo $this->createUrl('productTempprice/updatedetail' , array('companyId' => $model->dpid,'id'=>$product->lid));?>" class="btn default">返回</a>                              
										</div>
									</div>
							<?php $this->endWidget(); ?>
