		...
		<div class="col-md-12">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-globe"></i><?php echo $psmodel->name ;?>-><?php echo yii::t('app','套餐分类明细列表');?></div>
					<div class="actions">
					<?php if((Yii::app()->user->role == User::POWER_ADMIN)||($status==0 && Yii::app()->user->role >= User::ADMIN && Yii::app()->user->role <= User::SHOPKEEPER)):?>
						<a href="<?php echo $this->createUrl('productGroup/detailcreate' , array('companyId' => $this->companyId,'prodgroupId'=>$psmodel->lid,'type'=>0, 'papage'=>$papage));?>" class="btn blue"><i class="fa fa-pencil"></i> <?php echo yii::t('app','添加');?></a>
						<div class="btn-group">
					...
					<?php if($models):?>
						...
						<?php foreach ($models as $model):?>
							<tr class="odd gradeX">
								...
								<td class="center">
								<a href="<?php echo $this->createUrl('productGroup/detailupdate',array('lid' => $model->lid , 'companyId' => $model->dpid, 'type'=>'1' , 'status'=>$status, 'papage'=>$papage));?>"><?php echo yii::t('app','编辑');?></a>
								</td>             
							</tr>
						<?php endforeach;?>
						</tbody>
