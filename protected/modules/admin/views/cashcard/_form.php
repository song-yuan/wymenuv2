							...
							<div class="form-body">
									<div class="form-group">
										...
										<div class="col-md-4">
											<?php echo $form->dropDownList($model, 'is_normal_promotion', array('0' => yii::t('app','可以使用代金券') , '1' => yii::t('app','不能使用代金券')) , array('class' => 'form-control','placeholder'=>$model->getAttributeLabel('is_normal_promotion')));?>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<?php echo $form->dropDownList($model, 'is_private_promotion', array('0' => yii::t('app','可以使用代金券') , '1' => yii::t('app','不能使用代金券')) , array('class' => 'form-control','placeholder'=>$model->getAttributeLabel('is_private_promotion')));?>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<?php echo $form->dropDownList($model, 'is_cupon', array('0' => yii::t('app','可以使用代金券') , '1' => yii::t('app','不能使用代金券')) , array('class' => 'form-control','placeholder'=>$model->getAttributeLabel('is_cupon')));?>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<?php echo $form->dropDownList($model, 'is_cash', array('0' => yii::t('app','可以使用代金券') , '1' => yii::t('app','不能使用代金券')) , array('class' => 'form-control','placeholder'=>$model->getAttributeLabel('is_cash')));?>
											<?php echo $form->error($model, 'is_cash' )?>
										</div>
									</div><!-- 返现和充值是否有效 -->
										<!-- <div class="form-group">
											<php echo $form->label($model,'is_normal_promotion',array('class'=>'col-md-3 control-label')); ?>
											<div class="col-md-4">
												<php echo $form->textField($model,'is_normal_promotion',array('class'=>'form-control','placeholder'=>$model->getAttributeLabel('is_normal_promotion'))); ?>
												<php echo $form->error($model,'is_normal_promotion'); ?>
											</div>
										</div>
										<div class="form-group">
											<php echo $form->label($model,'is_private_promotion',array('class'=>'col-md-3 control-label')); ?>
											<div class="col-md-4">
												<div class="input-group">
												<php echo $form->textField($model,'is_private_promotion',array('class'=>'form-control','placeholder'=>$model->getAttributeLabel('is_private_promotion'))); ?>
