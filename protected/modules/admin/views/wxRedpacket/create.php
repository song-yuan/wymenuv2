	...
	<!-- BEGIN PAGE --> 	
		...
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->   
			<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array( 'head'=>yii::t('app','活动中心'),'subhead'=>yii::t('app','添加微信红包'),'breadcrumbs'=>array(array('word'=>yii::t('app','线上活动'),'url'=>$this->createUrl('discount/list' , array('companyId'=>$this->companyId,'type'=>1,))),array('word'=>yii::t('app','微信红包设置'),'url'=>$this->createUrl('wxRedpacket/index' , array('companyId' => $this->companyId))),array('word'=>yii::t('app','添加微信红包'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('wxRedpacket/index' , array('companyId' => $this->companyId)))));?>
					...
					<div class="col-md-12">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="fa fa-reorder"></i><?php echo yii::t('app','添加微信红包');?></div>
								<div class="tools">
