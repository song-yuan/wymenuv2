                                        	...
                                        	<?php $form=$this->beginWidget('CActiveForm', array(
                                                ...
                                                <div class="modal-footer">
                                                        ...
                                                        <input type="button" class="btn green" id="create_btn_add_retreat" value="确 定">
                                                </div>
					...
					'url':$('#retreat_form').attr('action'),
                                        success:function(result){                                                                                                                                       
                                                ...
                                                $modal.find('.modal-content').load('<?php echo $this->createUrl('default/retreatProduct',array('companyId'=>$this->companyId,'id'=>$orderRetreat->order_detail_id));?>'
                                                ,'', function(){
                                                  //$modal.modal();
