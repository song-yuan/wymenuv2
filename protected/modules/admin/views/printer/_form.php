							<?php $form=$this->beginWidget('CActiveForm', array(
								...
								<div class="form-group">
									...
									<div class="form-group">
										<?php echo $form->label($model, 'width_type',array('class' => 'col-md-3 control-label'));?>
										<div class="col-md-4">
											<?php echo $form->dropDownList($model, 'width_type', array('1' => yii::t('app','58mm') , '2' => yii::t('app','80mm')) , array('class' => 'form-control','placeholder'=>$model->getAttributeLabel('width_type')));?>
											<?php echo $form->error($model, 'width_type' )?>
										</div>
									</div>
									<div class="form-group">
