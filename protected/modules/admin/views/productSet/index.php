					...
					<?php if($models):?>
						...
						<?php foreach ($models as $model):?>
							<tr class="odd gradeX">
								...
								<td class="center">
									<a href="<?php echo $this->createUrl('productSet/update',array('lid' => $model->lid , 'companyId' => $model->dpid , 'status' => $model->source,'islock' => $model->is_lock, 'papage' => $pages->getCurrentPage()+1));?>"><?php echo yii::t('app','编辑');?></a>
								</td>
                                <td class="center">
