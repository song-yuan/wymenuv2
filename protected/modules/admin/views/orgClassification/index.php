<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','组织分类'),'subhead'=>yii::t('app','组织分类'),'breadcrumbs'=>array(array('word'=>yii::t('app','组织分类'),'url'=>''))));?>
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
				'id' => 'material-form',
				'action' => $this->createUrl('orgClassification/delete' , array('companyId' => $this->companyId)),
	...
	<div class="col-md-12">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-globe"></i><?php echo yii::t('app','组织分类表');?></div>
					<div class="actions">
						<a href="<?php echo $this->createUrl('orgClassification/create' , array('companyId' => $this->companyId));?>" class="btn blue"><i class="fa fa-pencil"></i> <?php echo yii::t('app','添加');?></a>
						<div class="btn-group">
