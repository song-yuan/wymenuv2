<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','品项入库'),'subhead'=>yii::t('app','品项入库列表'),'breadcrumbs'=>array(array('word'=>yii::t('app','品项入库'),'url'=>''))));?>
	...
	<div class="col-md-12">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo $this->createUrl('storageOrderDetail/create' , array('companyId' => $this->companyId));?>" class="btn blue"><i class="fa fa-pencil"></i> <?php echo yii::t('app','添加');?></a>
						<a href="<?php echo $this->createUrl('/admin/storageOrder/index' , array('companyId' => $this->companyId));?>" class="btn blue"> <?php echo yii::t('app','返回');?></a>
					</div>
				</div>
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<?php foreach ($models as $model):?>
							<tr class="odd gradeX">
								...
								<td class="center">
								<a href="<?php echo $this->createUrl('storageOrderDetail/update',array('id' => $model->lid , 'companyId' => $model->dpid));?>"><?php echo yii::t('app','编辑');?></a>
								</td>
							</tr>
						<?php endforeach;?>
						<?php endif;?>
