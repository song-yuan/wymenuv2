<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','进销存管理'),'subhead'=>yii::t('app','实时库存列表'),'breadcrumbs'=>array(array('word'=>yii::t('app','库存管理'),'url'=>$this->createUrl('bom/bom' , array('companyId'=>$this->companyId,'type'=>2,))),array('word'=>yii::t('app','实时库存列表'),'url'=>$this->createUrl('nowmaterialstock/index' , array('companyId'=>$this->companyId))),array('word'=>yii::t('app','原料库存详情'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('nowmaterialstock/index' , array('companyId' => $this->companyId,)))));?>
	...
	<div class="col-md-12">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-globe"></i><?php echo yii::t('app','原料库存详情');?></div>
					<div class="actions">
					<div class="btn-group">
