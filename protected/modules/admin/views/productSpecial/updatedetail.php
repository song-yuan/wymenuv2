<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>'特价活动管理','subhead'=>'特价活动列表','breadcrumbs'=>array(array('word'=>'特价活动管理','url'=>''))));?>
	...
	<div class="col-md-12">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-globe"></i>产品特价活动列表</div>
					<div class="actions">
						<a href="<?php echo $this->createUrl('productSpecial/create',array('companyId'=>$this->companyId,'productId'=>$productId));?>" class="btn blue"><i class="fa fa-pencil"></i> 添加</a>
					<div class="btn-group">
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<?php foreach ($models as $model):?>
							<tr class="odd gradeX">
								...
								<td class="center">
								<a href="<?php echo $this->createUrl('productSpecial/update',array('id' => $model->lid , 'companyId' => $model->dpid));?>">编辑</a>
								</td>
							</tr>
						<?php endforeach;?>
						<?php endif;?>
					    ...
					    <div class="form-actions fluid">
						        <div class="col-md-offset-3 col-md-9">
									...
									<a href="<?php echo $this->createUrl('productSpecial/index' , array('companyId' => $this->companyId));?>" class="btn default">返回</a>                              
								</div>
						</div>
