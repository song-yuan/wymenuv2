<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>"<?php echo yii::t('app','特价产品管理');?>",'subhead'=>"<?php echo yii::t('app','特价产品列表');?>",'breadcrumbs'=>array(array('word'=>"<?php echo yii::t('app','特价产品管理');?>",'url'=>''))));?>
	...
	$(document).ready(function(){
		$('.r-btn').on('switch-change', function () {
		    ...
		    $.get('<?php echo $this->createUrl('productSpecial/recommend',array('companyId'=>$this->companyId));?>/id/'+id);
		});
		$('.edit').click(function(){
			var id = $(this).attr('data-id');
			if($(this).parents('.odd').find('.toggle').is(':checked')){
				location.href = '<?php echo $this->createUrl('productSpecial/updatedetail',array('companyId' => $this->companyId));?>/id/'+id;
			}else{
				alert("<?php echo yii::t('app','请开启该单品特价');?>");
			}
			
		});
		$('#selectCategory').change(function(){
			var cid = $(this).val();
			location.href="<?php echo $this->createUrl('productSpecial/index' , array('companyId'=>$this->companyId));?>/cid/"+cid;
		});
	});
	</script>	