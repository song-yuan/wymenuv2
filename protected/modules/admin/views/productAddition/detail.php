<div class="page-content">
	...
	<div class="row">
            <?php $form=$this->beginWidget('CActiveForm', array(
				'id' => 'product-form',
				'action' => $this->createUrl('productAddition/delete' , array('companyId' => $this->companyId,'psid'=>$psmodel->lid)),
					...
					<?php if($models):?>
						...
						<?php foreach ($models as $model):?>
							<tr class="odd gradeX">
								...
								<td ><img width="100" src="<?php echo $model->sproduct->main_picture ;?>" /></td>
