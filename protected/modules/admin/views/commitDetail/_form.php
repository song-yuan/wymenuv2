	...
	<div class="form-body">
		...
		<div class="form-actions fluid">
			<div class="col-md-offset-3 col-md-9">
				...
				<a href="<?php echo $this->createUrl('commitDetail/index' , array('companyId' => $model->dpid));?>" class="btn default"><?php echo yii::t('app','返回');?></a>                              
			</div>
		</div>
<?php $this->endWidget(); ?>
...
<script>
	   ...
	   $('#selectCategory').change(function(){
		   ...
		   $.ajax({
			   url:'<?php echo $this->createUrl('commitDetail/getChildren',array('companyId'=>$this->companyId,));?>/pid/'+cid,
			   type:'GET',
			   dataType:'json',
