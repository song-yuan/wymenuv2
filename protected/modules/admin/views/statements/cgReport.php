	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','报表管理'),'subhead'=>yii::t('app','报表列表'),'breadcrumbs'=>array(array('word'=>yii::t('app','分类营业额报表'),'url'=>''))));?>
	...
	<div class="col-md-12">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					<div class="caption"><i class="fa fa-globe"></i><?php echo yii::t('app','分类营业额报表');?></div>
				<div class="actions">
...
// 		  });
		   ...
		   $('#btn_time_query').click(function time() {  
			  ...
			  // alert(111);
			   ...
			   var text = $('#text').val();
			  // var cid = $(this).val();
			   location.href="<?php echo $this->createUrl('statements/cgReport' , array('companyId'=>$this->companyId ));?>/begin_time/"+begin_time+"/end_time/"+end_time+"/text/"+text    
		   ...
		   $('#cx').click(function cx(){  
			   // var obj = document.getElementById('accept');
				...
				//alert(str);
					 ...
					 location.href="<?php echo $this->createUrl('statements/cgReport' , array('companyId'=>$this->companyId ));?>/str/"+str+"/begin_time/"+begin_time+"/end_time/"+end_time +"/text/"+text;	  
					 //return a; 
			 });
...
// 					str = str.substr(0,str.length-1);//除去最后一个“，”
			       ...
			       if(confirm('确认导出并且下载Excel文件吗？')){
			    	   ...
			    	   location.href="<?php echo $this->createUrl('statements/cgExport' , array('companyId'=>$this->companyId ));?>/str/"+str+"/begin_time/"+begin_time+"/end_time/"+end_time +"/text/"+text;
			       }
			       else{
