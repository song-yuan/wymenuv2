		        ...
		        <tr class="odd gradeX">
		            <td><?php 
		            		if($text==1){
								...
								echo $m['year_all'].-$m['month_all'];
							}else{
								echo $m['year_all'].-$m['month_all'].-$m['day_all'];
							}
					?></td>
		            <td><?php $orders_total = $orders_total+$m['all_nums20'];
		                echo $m['all_nums20'];?></td>
		            <td><?php
		            		$reality_all = $m['paytype_20'];
		            ...
		            <td><?php 
				            ...
				            //折扣
				            $discount=sprintf("%.2f",$reality_all-$m['paytype_22']);
		            ...
		            ?></td>
		            <td><?php
				            $wxorderpay = $m['paytype_12'];
				            $wxorder_total += $wxorderpay;
				            echo $wxorderpay;
		            ?></td>
		            <td><?php 
				            $wxwaimaipay = $m['paytype_13'];
