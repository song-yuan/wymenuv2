...
<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','数据中心'),'subhead'=>yii::t('app','营业数据'),'breadcrumbs'=>array(array('word'=>yii::t('app','营业数据'),'url'=>$this->createUrl('statements/list' , array('companyId'=>$this->companyId,'type'=>0,))),array('word'=>yii::t('app','办卡记录'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('statements/list' , array('companyId' => $this->companyId,'type'=>0)))));?>
	...
	<div class="col-md-12">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
				 ...
				 <div class="caption"><i class="fa fa-globe"></i><?php echo yii::t('app','办卡记录报表');?></div>
					 <div class="actions">
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						<thead>
							<tr>
                                ...
                                <th><?php echo yii::t('app','卡状态');?></th>
								<th><?php echo yii::t('app','办卡时间');?></th>
				...
				<?php elseif ($text == 3) :?>
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						<thead>
							<tr>
								<th width=100px;><?php echo yii::t('app','会员卡类型');?></th>
                                <th><?php echo yii::t('app','办卡数量');?></th>  
								<th><?php echo yii::t('app','备注');?></th>
							</tr>
						</thead>
						<tbody>
						<!--foreach-->
				 			...
				 			<tr class="odd gradeX">
								...
								<td><?php if($membercard) echo $membercard['card_num'];else echo '';?></td>
								<td></td>
							</tr>
							<tr class="odd gradeX">
								<td><?php echo yii::t('app','会员卡');?></td>
								<td><?php if($branduser) echo $branduser['brand_num'];else echo '';?></td>
								<td></td>
							</tr>
						</tbody>
					</table>
...
<script>
		jQuery(document).ready(function(){
          ...
          $('#btn_time_query').click(function() {  
			   ...
			   var text = $('#text').val();
			   location.href="<?php echo $this->createUrl('statements/membercard' , array('companyId'=>$this->companyId ));?>/begin_time/"+begin_time+"/end_time/"+end_time+"/text/"+text+"/page/"    
		 ...
		 $('#excel').click(function excel(){
		       ...
		       if(confirm('确认导出并且下载Excel文件吗？')){
		    	   //location.href="<?php echo $this->createUrl('statements/membercardExport' , array('companyId'=>$this->companyId ));?>/begin_time/"+begin_time+"/end_time/"+end_time +"/text/"+text;
		       }
		       else{
