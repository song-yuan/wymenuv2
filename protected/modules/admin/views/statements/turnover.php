	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','数据中心'),'subhead'=>yii::t('app','营业数据'),'breadcrumbs'=>array(array('word'=>yii::t('app','订单报表'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('statements/list' , array('companyId' => $this->companyId,'type'=>0)))));?>
		   ...
		   $('#cx').click(function(){  
			  ...
			  $('#excel').click(function excel(){
			       ...
			       if(confirm('确认导出并且下载Excel文件吗？')){
			    	   ...
			    	   location.href="<?php echo $this->createUrl('statements/TurnoverReportExport' , array('companyId'=>$this->companyId,'d'=>1));?>/begin_time/"+begin_time+"/end_time/"+end_time;
			       }
			       else{
