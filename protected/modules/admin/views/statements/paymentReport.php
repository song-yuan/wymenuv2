				...
				<div class="portlet-body" id="table-manage">
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<?php foreach ($models as $model):?>
								...
								<td><?php echo $this->getPaymentPrice($model->dpid,0,0,$text,$model->y_all,$model->m_all,$model->d_all);?></td>
								<td><?php echo $this->getPaymentPrice($model->dpid,0,1,$text,$model->y_all,$model->m_all,$model->d_all);?></td>
								<td><?php echo $this->getPaymentPrice($model->dpid,0,2,$text,$model->y_all,$model->m_all,$model->d_all);?></td>
								<td><?php echo $this->getPaymentPrice($model->dpid,0,5,$text,$model->y_all,$model->m_all,$model->d_all);?></td>
								<td><?php echo $this->getPaymentPrice($model->dpid,0,4,$text,$model->y_all,$model->m_all,$model->d_all);?></td>
								 <?php if($payments):?>
                                <?php foreach ($payments as $payment):?>
                                <td><?php echo $this->getPaymentPrice($model->dpid,3,$payment['lid'],$text,$model->y_all,$model->m_all,$model->d_all);?></td>
                                <?php endforeach;?>
                                <?php endif;?> 
								<td><?php ?></td>
		...
		jQuery(document).ready(function(){
		   ...
		   $('#btn_time_query').click(function time() {  
			  ...
			  // alert(111);
			   ...
			   var text = $('#text').val();
			  // var cid = $(this).val();
			   location.href="<?php echo $this->createUrl('statements/paymentReport' , array('companyId'=>$this->companyId ));?>/begin_time/"+begin_time+"/end_time/"+end_time+"/text/"+text    
