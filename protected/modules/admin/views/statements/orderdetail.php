...
<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','订单管理'),'subhead'=>yii::t('app','账单列表'),'breadcrumbs'=>array(array('word'=>yii::t('app','账单详情查询'),'url'=>''))));?>
