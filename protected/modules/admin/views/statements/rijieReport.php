...
jQuery(document).ready(function(){
	...
	$('#excel').click(function excel(){
		...
		if(confirm('确认导出并且下载Excel文件吗？')){
			location.href="<?php echo $this->createUrl('statements/rijieReport' , array('companyId'=>$this->companyId));?>/begin_time/"+begin_time+"/end_time/"+end_time+"/text/"+text+"/userid/"+userid+"/d/1";
		}
	});
