<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('head'=>yii::t('app','品项单位系数'),'subhead'=>yii::t('app','单位系数列表'),'breadcrumbs'=>array(array('word'=>yii::t('app','品项单位系数'),'url'=>''))));?>
	...
	<?php $form=$this->beginWidget('CActiveForm', array(
				'id' => 'material-form',
				'action' => $this->createUrl('materialUnitRatio/delete' , array('companyId' => $this->companyId)),
	...
	<div class="col-md-12">
			...
			<div class="portlet box purple">
				<div class="portlet-title">
					...
					<div class="actions">
						<a href="<?php echo $this->createUrl('materialUnitRatio/create' , array('companyId' => $this->companyId));?>" class="btn blue"><i class="fa fa-pencil"></i> <?php echo yii::t('app','添加');?></a>
						<div class="btn-group">
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						...
						<?php foreach ($models as $model):?>
							<tr class="odd gradeX">
								...
								<td style="width:16%"><?php echo $model->stock_unit_id;?></td>
