...
<div class="page-content">
 ...
 <?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('breadcrumbs'=>array(array('word'=>yii::t('app','实体卡'),'url'=>$this->createUrl('entityCard/list' , array('companyId'=>$this->companyId,'type'=>0,))),array('word'=>yii::t('app','清零'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('entityCard/list' , array('companyId' => $this->companyId,'type'=>0)))));?>
            ...
            <!-- BEGIN FORM-->
                ...
                <div class="col-md-offset-2 col-md-6" >
                    <?php $form=$this->beginWidget('CActiveForm', array(
                        'id' => 'taste-form',
                        'action'=>$this->createUrl('entityCard/zero',array('companyId'=>$this->companyId)),
...
jQuery(document).ready(function(){
        ...
        $.get(
                '<?php echo $this->createUrl('/admin/entityCard/GetMember', 
                array('companyId' => $model->dpid));?>/card/'+card,
                function(data){
                        if(data.status){
