	...
	<!-- BEGIN PAGE -->  
		<div class="page-content">
			...
			<!-- BEGIN PAGE HEADER-->   
			<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array( 'head'=>yii::t('app','营销管理'),'subhead'=>yii::t('app','满送优惠查询'),'breadcrumbs'=>array(array('word'=>yii::t('app','营销管理'),'url'=>''),array('word'=>yii::t('app','营销品设置'),'url'=>''),array('word'=>yii::t('app','修改满送优惠活动'),'url'=>'')),'back'=>array('word'=>'返回','url'=>$this->createUrl('fullSentPromotion/index' , array('companyId' => $this->companyId,)))));?>
		<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
			<div class="row">
				<div class="col-md-12">
