...
<div class="page-content">
	...
	<div class="modal fade" id="portlet-config" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<!-- /.modal-dialog -->
			...
			<!-- BEGIN PAGE HEADER-->
		<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array( 'head'=>yii::t('app','活动中心'),'subhead'=>yii::t('app','满送优惠查询'),'breadcrumbs'=>array(array('word'=>yii::t('app','线下活动'),'url'=>$this->createUrl('discount/list' , array('companyId'=>$this->companyId,'type'=>0,))),array('word'=>yii::t('app','满送优惠查询'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('discount/list' , array('companyId' => $this->companyId,'type'=>0)))));?>
			<!-- END PAGE HEADER-->
			<!-- BEGIN PAGE CONTENT-->
		<div class="row">
					...
					<table class="table table-striped table-bordered table-hover" id="sample_1">
						<thead>
							<tr>
                                ...
                                <th><?php echo yii::t('app','参与溢价购商品');?></th>
                                <th><?php echo yii::t('app','限制领取数量');?></th>
						...
						<?php foreach ($models as $model):?>
								...
								<td><?php echo "";?></td>
								<td><?php echo $model->sent_number;?></td>
								<td class="center">
								<a href="<?php echo $this->createUrl('fullSentPromotion/update',array('lid' => $model->lid , 'companyId' => $model->dpid));?>"><?php echo yii::t('app','编辑');?></a></td>
								<td class="center">
								<a href="<?php echo $this->createUrl('fullSentPromotion/detailindex',array('lid' => $model->lid , 'companyId' => $model->dpid ,'typeId'=>'product'));?>"><?php echo yii::t('app','设置活动优惠产品');?></a></td>
								 <td><?php echo '';?></td>
								</tr>
