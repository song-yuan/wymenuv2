<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<?php $this->widget('application.modules.admin.components.widgets.PageHeader', array('breadcrumbs'=>array(array('word'=>yii::t('app','商城设置'),'url'=>$this->createUrl('tmall/list' , array('companyId'=>$this->companyId,'type'=>0))),array('word'=>yii::t('app','发货单列表'),'url'=>$this->createUrl('goodsinvoice/goodsinvoice' , array('companyId'=>$this->companyId))),array('word'=>yii::t('app','发货单明细'),'url'=>'')),'back'=>array('word'=>yii::t('app','返回'),'url'=>$this->createUrl('goodsinvoice/goodsinvoice' , array('companyId' => $this->companyId,'page'=>$papage)))));?>
