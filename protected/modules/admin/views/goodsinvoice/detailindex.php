...
<div class="page-content">
	...
	$(document).ready(function(){
		...
		$(".add_btn").live('click',function() {
			...
			if (x+y+i<6) {
				$("#nb_bottom").append(
				"<tr class='indexx'><td style='width:10%;border:1px solid #ccc!important;'><input style='color:red;font-weight:900;width:100%;' name='sort_no[]' value='"+(x+i+y-1)+"'></td><td style='border:1px solid #ccc!important;'><input type='text' name='content[]' lid='' value='' class='form-control'></td><td style='border:1px solid #ccc!important;'><i class='fa fa-times btn btn-xs red btn_delete' val=''></i></td></tr>"
							);
			}else{
				--i;
