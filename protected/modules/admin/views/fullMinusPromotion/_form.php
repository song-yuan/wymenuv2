							<?php $form=$this->beginWidget('CActiveForm', array(
								...
								<div class="form-body">
									...
									<?php if($model->hasErrors('extra_cost')) echo 'has-error';?>
										<?php echo $form->label($model, yii::t('app','减价金额'),array('class' => 'col-md-3 control-label'));?>
										<div class="col-md-4">
									...
									<div class="form-actions fluid">
										<div class="col-md-offset-3 col-md-9">
											...
											<a href="<?php echo $this->createUrl('fullMinusPromotion/index' , array('companyId' => $model->dpid));?>" class="btn default"><?php echo yii::t('app','返回');?></a>                              
										</div>
									</div>
							<?php $this->endWidget(); ?>
