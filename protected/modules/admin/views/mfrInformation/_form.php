<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-body">
		...
		<div class="form-group <?php if($model->hasErrors('manufacturer_code')) echo 'has-error';?>">
			<?php echo $form->label($model, 'manufacturer_code',array('class' => 'col-md-3 control-label'));?>
			<div class="col-md-4">
				<?php echo $form->textField($model, 'manufacturer_code',array('class' => 'form-control','placeholder'=>$model->getAttributeLabel('manufacturer_code')));?>
				<?php echo $form->error($model, 'manufacturer_code' )?>
			</div>
		</div>
		<div class="form-group" <?php if($model->hasErrors('manufacturer_name')) echo 'has-error';?>>
			<?php echo $form->label($model, 'manufacturer_name',array('class' => 'col-md-3 control-label'));?>
			<div class="col-md-4">
				<?php echo $form->textField($model, 'manufacturer_name',array('class' => 'form-control','placeholder'=>$model->getAttributeLabel('manufacturer_name')));?>
		...
		<div class="form-actions fluid">
			<div class="col-md-offset-3 col-md-9">
				...
				<a href="<?php echo $this->createUrl('mfrInformation/index' , array('companyId' => $model->dpid));?>" class="btn default"><?php echo yii::t('app','返回');?></a>                              
			</div>
		</div>
<?php $this->endWidget(); ?>
...
$('#category_container').on('change','.category_selecter',function(){
	...
	$(this).nextAll().remove();
	$.ajax({
		url:'<?php echo $this->createUrl('mfrInformation/getChildren',array('companyId'=>$this->companyId));?>/pid/'+id,
	type:'GET',
	dataType:'json',
