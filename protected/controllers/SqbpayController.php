...
class SqbpayController extends Controller
{
	...
	public function actionWappayresult(){
		...
		if($is_success == 'F'){
			...
			$data = '{"from":"result";"is_success":"'.$is_success.'";"sn":"'.$sn.'";"status":"'.$status.'";"result_code":"'.$result_code.'";"result_message":"'.$result_message.'"}';
	...
	public function actionWappayreturn(){
		...
		if($is_success == 'F'){
			...
			$data = '{"from":"return";"is_success":"'.$is_success.'";"sn":"'.$sn.'";"status":"'.$status.'";"result_code":"'.$result_code.'";"result_message":"'.$result_message.'"}';
			Helper::writeLog($data);
		}
	}
}