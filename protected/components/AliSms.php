...
require_once dirname(__DIR__) . '/extensions/AliSms/vendor/autoload.php';
...
class AliSms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "KrVSHKtMM1SqsWOl"; // AccessKeyId

        $accessKeySecret = "iU0hdAAIQX9fZSq7UVR0QaAK2t6SZW"; // AccessKeySecret
    ...
    public static function sendSms($mobile,$code) {
        ...
        $request->setSignName("壹点吃");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_149423518");
