		...
		try {
			...
			foreach ( $results as $result ) {
				...
				foreach ( $orderProduct as $k => $product ) {
					...
					$sql = 'select promotion_title,promotion_type,promotion_id,promotion_money,can_cupon from nb_order_taste where order_id=' . $product ['lid'] . ' and dpid='.$dpid.' and is_order=0 and delete_flag=0';
