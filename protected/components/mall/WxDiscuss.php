...
class WxDiscuss
{
	...
	public static function get($dpid,$screenId = 0){
		$sql = 'select t.lid,t.dpid,t.content,t1.nickname from nb_discuss t,nb_brand_user t1 where t.dpid=t1.dpid and t.branduser_lid =t1.lid and t.dpid=:dpid and t.show_flag=0 and t.delete_flag=0';
