...
class WxOrder
{
	...
	public static function getUserOrderList($userId,$cardId,$type,$page){
		if($type==1){
			$sql = 'select * from (select * from nb_order where user_id='.$userId.' and order_type in (1,2,3,6) and order_status in (1,2)';
			...
			$sql = 'select * from (select * from nb_order where user_id='.$userId.' and order_type in (1,2,3,6) and order_status in (3,4,8)';
			...
			$sql = 'select * from (select * from nb_order where user_id='.$userId.' and order_type in (1,2,3,6) and order_status in (1,2,3,4,8)';
