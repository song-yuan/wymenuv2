...
class WxPromotion
{
	...
	public function getUserPromotion(){
		...
		foreach($results as $k=>$result){
			$sql = 'select m.*,n.num from (select t1.lid,t.is_set,t.is_discount,t.promotion_money,t.promotion_discount,t.order_num,t1.product_name,t1.main_picture,t1.original_price from nb_private_promotion_detail t,nb_product t1 where t.product_id=t1.lid and t.dpid=t1.dpid and t.dpid=:dpid and t.private_promotion_id=:promotionId and t.delete_flag=0)m left join nb_cart n on m.lid=n.product_id and n.user_id=:userId and n.site_id=:siteId and privation_promotion_id=:promotionId';
