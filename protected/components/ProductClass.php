...
//		return $product;
	...
	public static function getCartInfo($dpid = 0,$siteNoId = 0){
		...
		$sql = 'select lid,dpid,create_at,update_at,order_id,set_id,main_id,product_id,is_retreat, price,offprice,amount,zhiamount,is_waiting,weight,taste_memo,is_giving,is_print,delete_flag,product_order_status from nb_order_product where order_id=:orderId and dpid=:dpid and delete_flag = 0 and product_order_status = 0 and set_id = 0 ' .
