...
class OrderList
{
	...
	public function GetSetProduct($setId){
		$result = array();
		$sql = 'select t.*, t1.product_name, t1.main_picture from nb_product_set_detail t left join nb_product t1 on t.product_id=t1.lid where t.set_id=:setId and t.dpid=t1.dpid and t.dpid=:dpid and t.delete_flag=0 order by is_select desc';
		$conn = $this->db->createCommand($sql);
