			...
			<ul id="allshop">
				...
				<li href="<?php echo $this->createUrl('/mall/index',array('companyId'=>$child['dpid'],'type'=>$type));?>" distance="" searil="<?php echo $k;?>" lat="<?php echo $child['lat'];?>" lng="<?php echo $child['lng'];?>">
					<div class="right">
						...
						<div class="info small font_l" style="margin-top:5px;">地址: <?php echo $child['province'].($child['city']!='市辖区'?$child['city']:'').$child['county_area'].$child['address'];?><span><img alt="" src="<?php echo $baseUrl;?>/img/wechat_img/icon_location.png" width="14px" height="14px"></span></div>
