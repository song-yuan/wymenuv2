...
<div class="cart-info">
	<div class="section clearfix">
	    ...
	    <?php endif;?>
	    <div class="right" style="color:rgb(51,51,51);"><a href="<?php echo $this->createUrl('/mall/index',array('companyId'=>$this->companyId,'type'=>$this->type));?>"><img style="width:25px;height:25px;vertical-align:middle;" alt="" src="../img/mall/icon_add.png">继续加菜</a></div>
	</div>
