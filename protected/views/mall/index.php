				...
				for(var i=0; i<promotions.length; i++){
					...
					if(promotionProduct.price != promotionProduct.original_price){
             		...
             		if(parseInt(promotionProduct.num)){
             				promotionStr +='<div class="lt-rt"><div class="minus">-</div><input type="text" class="result" is-set="'+promotionProduct.is_set+'" product-id="'+promotionProduct.lid+'" promote-id="'+promotion.normal_promotion_id+'" to-group="'+promotion.to_group+'" store-number="'+promotion.all_order_num+'" readonly value="'+promotionProduct.num+'">';
            				promotionStr +='<div class="add">+</div><div class="clear"></div></div></div>';
             		}else{
             			if(parseInt(promotionProduct.store_number) != 0){
             				promotionStr +='<div class="lt-rt"><div class="minus zero">-</div><input type="text" class="result zero" is-set="'+promotionProduct.is_set+'" product-id="'+promotionProduct.lid+'" promote-id="'+promotion.normal_promotion_id+'" to-group="'+promotion.to_group+'" store-number="'+promotion.all_order_num+'" readonly value="0">';
