...
<?php if($this->brandUser['user_name']&&$this->brandUser['mobile_num']):?>
	...
	<?php if($payChannel==1):?>
		...
		<div class="item"  onclick="jsApiCall('<?php echo $recharge['lid'];?>','<?php echo $recharge['dpid'];?>','<?php echo $recharge['recharge_money'];?>')">
			...
			<div class="down">
			<?php if($recharge['recharge_cashback']!=0):?>赠送<?php echo $recharge['recharge_cashback'];?>元<?php endif;?>
			<?php if($recharge['recharge_pointback']!=0):?>赠送<?php echo $recharge['recharge_pointback'];?>积分<?php endif;?>
