<?php $this->beginContent('//layouts/brandlayouts.php'); ?>
<style>
		...
		foreach($wxCards as $key=>$wxCard){
			...
			<div class="card" id="batchAddCard<?php echo $key;?>">
				<div class="inner" style="background-color:<?php echo $wxCard['color'];?>">
					<div class="inner-top"><div class="left"><img src="<?php echo $wxCard['logo'];?>" /></div><div class="right"><?php echo $wxCard['title'];?></div></div>
