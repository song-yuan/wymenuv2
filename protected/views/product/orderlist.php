...
<div class="order-time"><div class="order-time-left"><?php echo date('Y-m-d H:i:s',time());?></div><div class="order-time-right">全单做法口味选择</div></div>
...
<div class="order-product">
	...
	<div class="order-product-right">
		...
		<div class="right-down">
		 ...
		 <div class="right-down-right">做法口味选择</div>	
		</div>
	</div>
	<div class="clear"></div>
</div>
