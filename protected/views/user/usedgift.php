...
<body class="gift_exchange bg_lgrey2">
	<div id="topnav">
		<ul>
			...
			<li class="used current"><a href="<?php echo $this->createUrl('/user/usedGift',array('companyId'=>$this->companyId));?>"><span>已使用</span></a></li>
	...
	<div class="couponlist with_topbar">
		...
		<ul id="used">
			...
			<li>
				...
				<span class="info"><h2><?php echo $gift['title'];?></h2><span class="small">有效期：<?php echo date('Y-m-d',strtotime($gift['begin_time']));?>-<?php echo date('Y-m-d',strtotime($gift['end_time']));?></span></span>
				<span class="status"><img src="<?php echo $baseUrl;?>/img/mall/coupon_used.png" alt=""></span>
			</li>
			<?php endforeach;?>
		</ul>
		<!-- 已使用 -->
