...
<body class="members bg_lgrey2">
	...
	-->
	<div class="listset">
		<div class="arrowright"><a href="<?php echo $this->createUrl('/user/reCharge',array('companyId'=>$this->companyId));?>">余额 <span class="small font_l"> <?php echo number_format($user['remain_money'] + $user['remain_back_money'],2);?></span></a>
		</div>
	</div>
