	...
	<div class="orderlist with_topbar">
		...
		<ul id="all">
			...
			<li class="bg_white">
				...
				<a href="<?php echo $this->createUrl('/mall/order',array('companyId'=>$this->companyId,'orderId'=>$model['lid']));?>">
				<?php else:?>
				...
				<div class="headinfo colclear bottom_dash pad_10">
					...
					<div class="shortinfo2 noborder bottom_dash">
						...
						<div class="right">
						<h2>类型 : <?php if($model['order_type']==1) echo '堂吃';elseif($model['order_type']==2) echo '外卖';else echo '预约';?></h2><br />
