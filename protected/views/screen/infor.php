...
<div class="section">
	<h2><?php echo $screen['title'];?><small class="right"><a href="<?php echo $this->createUrl('screen/discuss',array('companyId'=>$this->companyId,'screenId'=>$screen['lid']));?>">弹幕</a></small></h2>
