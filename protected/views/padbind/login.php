				...
				<div class="col-md-12">
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="fa fa-reorder"></i>绑定PAD登录界面</div>
							<div class="tools">
						...
						<div class="portlet-body form">								<div class="form-body">
									<div class="form-group ">
                                                                            <form id="login-form" action="/wymenuv2/padbind/login" method="post">			
                                                                                <h3 class="form-title"><?php if($model->username!="") echo "用户名或密码错误"; else echo "输入管理员用户名和密码"; ?></h3>
                                                                                <div class="alert alert-danger display-hide">
                                                                                        <button class="close" data-close="alert"></button>
                                                                                        <span><?php if($model->username!="") echo "用户名或密码错误"; else echo "输入管理员用户名和密码"; ?></span>
                                                                                </div>
                                                                                <div class="form-group ">
                                                                                        ...
                                                                                        <div class="input-icon">
                                                                                                ...
                                                                                                <input class="form-control placeholder-no-fix" autocomplete="off" placeholder="用户名" name="LoginForm[username]" id="LoginForm_username" type="text">				
                                                                                        </div>
                                                                                </div>
                                                                                <div class="form-group  ">
                                                                                        ...
                                                                                        <div class="input-icon">
                                                                                                ...
                                                                                                <input class="form-control placeholder-no-fix" autocomplete="off" placeholder="密码" name="LoginForm[password]" id="LoginForm_password" type="password">				
                                                                                        </div>
                                                                                </div>
