...
/**
 * This is the model class for table "nb_redpacket_detail".
 *
 * The followings are the available columns in table 'nb_redpacket_detail':
 * @property string $lid
...
class RedpacketDetail extends CActiveRecord
{
	 ...
	 * @return RedpacketDetail the static model class
	 */
