...
/**
 * This is the model class for table "nb_private_promotion_detail".
 *
 * The followings are the available columns in table 'nb_private_promotion_detail':
 * @property string $lid
...
class PrivatePromotionDetail extends CActiveRecord
{
	...
	{
		return 'nb_private_promotion_detail';
	}
	...
	public function rules()
	{
		...
		return array(
			array('update_at, is_set', 'required'),
			array('is_set, order_num', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			...
			'create_at' => 'Create At',
			'update_at' => 'Update At',
			'private_promotion_id' => 'Private Promotion',
			'product_id' => '单品或者套餐的id',
			'is_set' => '是否是套餐或者单品；0是单品，1是套餐',
	 ...
	 * @return PrivatePromotionDetail the static model class
	 */
