...
/**
 * This is the model class for table "nb_material_price_group".
 *
 * The followings are the available columns in table 'nb_material_price_group':
 * @property string $lid
 ...
 */
class MaterialPriceGroup extends CActiveRecord
{
    /**
    ...
    {
        return 'nb_material_price_group';
    }
     ...
     * @return MaterialPriceGroup the static model class
     */
