...
/**
 * This is the model class for table "nb_manufacturer_classification".
 *
 * The followings are the available columns in table 'nb_manufacturer_classification':
 * @property string $lid
 ...
 */
class ManufacturerClassification extends CActiveRecord
{
	/**
	...
	{
		return 'nb_manufacturer_classification';
	}
	...
	public function rules()
	{
		...
		return array(
			array('update_at, classification_name, remark', 'required'),
	 ...
	 * @return ManufacturerClassification the static model class
	 */
