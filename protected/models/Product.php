...
class Product extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			...
			'productInstruct' => array(self::HAS_MANY , 'ProductInstruction' ,'','on'=>'t.lid=productInstruct.product_id and t.dpid=productInstruct.dpid and productInstruct.is_taste=0 and productInstruct.delete_flag=0'),
		);
	}
