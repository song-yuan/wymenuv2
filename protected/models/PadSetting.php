...
class PadSetting extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('pad_sales_type, pad_type', 'length', 'max'=>2),
			...
			array('lid, dpid, create_at, update_at, pad_code, pad_sales_type, pad_type, pad_ip, pad_fip, bt_mac, is_product_free, sync_at, delete_flag, is_sync', 'safe', 'on'=>'search'),
		);
	}
