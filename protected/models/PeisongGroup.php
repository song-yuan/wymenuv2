...
/**
 * This is the model class for table "nb_peisong_group".
 *
 * The followings are the available columns in table 'nb_peisong_group':
 * @property string $lid
 ...
 */
class PeisongGroup extends CActiveRecord
{
	/**
	 ...
	 * @return PeisongGroup the static model class
	 */
