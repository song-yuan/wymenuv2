...
/**
 * This is the model class for table "nb_sentwxcard_promotion".
 *
 * The followings are the available columns in table 'nb_sentwxcard_promotion':
 * @property string $lid
 ...
 * @property string $promotion_message
 ...
 */
class SentwxcardPromotion extends CActiveRecord
{
	/**
	...
	{
		return 'nb_sentwxcard_promotion';
	}
	...
	public function relations()
	{
		...
		return array(
				'sentwxcarDet' => array(self::BELONGS_TO , 'SentwxcardPromotionDetail' ,'' ,'on'=>'t.dpid = sentwxcarDet.dpid and t.lid = sentwxcarDet.sentwxcard_pro_id '),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'type' => '0表示开卡关怀，1表示填写资料赠券，',
			'promotion_message' => '发送给用户的消息',
			'begin_time' => '开始时间',
			'end_time' => '结束时间',
			'weekday' => '星期几',
			'day_begin' => '时间段 开始时间',
...
时间',
	...
	public function search()
	{
		...
		$criteria->compare('promotion_message',$this->promotion_message,true);
	 ...
	 * @return SentwxcardPromotion the static model class
	 */
