...
/**
 * This is the model class for table "nb_area_group".
 *
 * The followings are the available columns in table 'nb_area_group':
 * @property string $lid
 ...
 */
class AreaGroup extends CActiveRecord
{
    /**
     ...
     * @return AreaGroup the static model class
     */
