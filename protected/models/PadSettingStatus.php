 ...
 *
 * ALTER TABLE `nb_pad_setting_status` ADD `pad_no` TINYINT(3) UNSIGNED NOT NULL DEFAULT '1' AFTER `use_status`;
 *
 * 
...
class PadSettingStatus extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('pad_no', 'numerical', 'integerOnly'=>true),
            ...
            array('lid, dpid, create_at, update_at, pad_setting_id, status, use_status, pad_no, delete_flag, is_sync', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('pad_no',$this->pad_no);
