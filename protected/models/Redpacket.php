...
/**
 * This is the model class for table "nb_redpacket".
 *
 * The followings are the available columns in table 'nb_redpacket':
 * @property string $lid
 * @property string $dpid
 * @property string $create_at
 * @property string $update_at
 * @property string $redpacket_name
 * @property string $send_userlid
...
class Redpacket extends CActiveRecord
{
	...
	public function search()
	{
		...
		$criteria->compare('redpacket_name',$this->redpacket_name,true);
		$criteria->compare('send_userlid',$this->send_userlid,true);
