...
function showListPad(items){
	...
	for(var i in items){
		...
		if(leftHeight > rightHeight){
			...
			var trPic = '<a class="product-pic" lid="'+item.lid+'" href="javascript:;"><img style="width:100%;margin:0;" src="'+thumb+'" id="p'+item.lid+'"><i class="icon-hover-1 view-product-pic"><img src="../../../../../img/product/icon_search.png" style="width:32px;height:32px;"/></i><i class="icon-hover-2 addCart"><img src="../../../../../img/product/icon_cart.png" style="width:32px;height:32px;"/></i></a>';
			var trBuy = ' <div class="productbuy"><div class="inmiddle">'+item.product_name+'</div></div>';
