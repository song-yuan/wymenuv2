...
function showListPad(items){
	...
	for(var i in items){
		...
		if(leftHeight > rightHeight){
			...
			trTaste +='<div class="taste-select">选择</div><div class="taste-same"></div><div class="taste-none">无</div></div><div class="clear"></div><input class="input-product " type="hidden" name="taste-num" value="1" />';
